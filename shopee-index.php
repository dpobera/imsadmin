...
<body style="background-color: white;">
    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm b-light" style="border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">ONLINE SALES RECORDS</h1>
            ...
            <!-- table container -->
            <div class="container-fluid bg-light" style="border:1px solid lightgrey">
                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                    <div class="row">
                        <div class="col-9">
                            <div class="form-floating mb-2">
                                <select class="form-select form-select-sm" id="dropdown1" aria-label="Floating label select example" style="width:50%">
                                    <option value=" " selected> Show All </option>
                                    <option value="SHOPEE">SHOPEE</option>
                                    <option value="LAZADA">LAZADA</option>
                                </select>
                                <label for="floatingSelect">Select Platform</label>
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <table id="example" class="table table-hover table-sm" style="background-color:white;border:1px solid lightgrey">
                        ...
                        <thead class="table-light bg-gradient table-sm sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                            ...
                            <th style="color:grey;" width="10%">&nbsp;OL ID</th>
                            <th style="color:grey;" width="30%">STATEMENT</th>
                            <th style="color:grey" width="10%">SI NO.</th>
                            <th style="color:grey" width="10%">SALES TYPE</th>

                            <th style="color:grey;text-align:center" width="10%">DATE</th>
                            <th style="color:grey;text-align:left" width="10%">ACTION</th>
