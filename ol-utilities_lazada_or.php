    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">Official Receipt Generator / LAZADA</h1>
                    ...
                    <div class="mb-3">
                        <div class="card mt-3 shadow-sm">
                            <div class="card-header text-secondary font-monospace">
                                Select Statement from Lazada Online Sales
                            </div>
                            <div class="card-body">
                                <div class="form-floating mt-3">
                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="ol_set">
                                        ...
                                        $records = mysqli_query($db, "SELECT ol_title FROM ol_tb
                                            WHERE ol_tb.ol_type_id = 1 AND ol_tb.ol_id <> 1
                                            GROUP BY ol_title
                                            ORDER BY ol_id DESC");
                                ...
                                <div class="mt-3 float-end">
                                    ...
                                    <a href="ol-utilities_lazada_or.php?ol_set=----------&submit=&setAmount=0&fcTotal=0&grandTot=0&addTot=0> <button type=" button" class="btn btn-secondary bg-gradient btn-sm"> Reset Data</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                    ...
                                    <form action="view/ol_or.php" method="GET">
                                        ...
                                        <div class="col fs-small" id="printDiv" style="padding:2%;border:1px solid lightgrey">
