...
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0) {
    ...
    $result = mysqli_query($db, "SELECT order_tb.order_id, customers.customers_name, order_tb.pos_date, jo_tb.jo_no, jo_tb.jo_date, user.user_name,order_tb.dr_number
    FROM order_tb
...
<body>
    ...
    <div class="container" id="printDiv">
        ...
        <table class="header">
            <tr>
                ...
                <td><label for="">DR No. :</label>  <?php echo $drNo; ?></td>
            </tr>
            <tr>
    ...
    <br>
    <a href="../pos-utilities.php"><button style="float: right;">Cancel</button></a> <button style="float: left;" id="doPrint">Print Record</button>
</body>
