    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">PURCHASE ORDER RECORDS</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        <!-- <button type="button" class="btn btn-sm btn-outline-secondary">Export</button> -->
                        <div class="btnAdd">
                            <a href="addpo.php" class="btn btn-sm btn-secondary bg-gradient">
                                Add New Record</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- table container -->
            <div class="container-fluid shadow-sm bg-light" style="background-color:#ededed;border:1px solid lightgrey;">
                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                    <table id="example" class="table table-hover table-sm shadow" style="background-color:white;border:1px solid lightgrey">
                        <thead class="table-light bg-gradient table-sm sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                            ...
                            <!-- <th width="20%">PREP BY</th> -->
                            <!-- <th width="10%" class="text-center">RS DATE</th> -->
                            <th width="5%" class="text-center">STATUS</th>
                            <th width="10%" class="text-center">RECEIVED DATE</th>
