...
<body style="background-color: white;">
                    ...
                    <div class="col-4">
                        <div class="card mt-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="addrecord/itemInsert/classInsert.php">
                                    ...
                                    <div class="row mb-3 float-end">
                                        <div class="col"><button type="submit" class="btn btn-secondary bg-gradient btn-sm" name="addClass">Save Record</button></div>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        $(document).on("click", ".open-staticBackdrop", function() {
