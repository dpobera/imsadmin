    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">DELIVERY RECEIPTS REPORT (Customer)</h1>
            ...
            <div class="container-fluid bg-light" style="background-color:#ededed;border:1px solid lightgrey;font-family:monospace;">
                <div class="row">
                    <div class="col-4">
                                ...
                                <form class="form-inline" method="GET" action="" autocomplete="off">
                                    <div class="range">
                                        ...
                                        <div class="float-end mt-3">
                                            ...
                                            <a href="sales-report.php?date1=&date2="><button type="button" class="btn btn-secondary bg-gradient btn-sm">Cancel</button></a>
                    ...
                    <div class="col-8">
                        <div class="card mt-4 mb-4">
                            <h6 class="card-header text-secondary">DR REPORTS</h6>
                            <div class="card-body">
                                <div class="p-5 mt-3 bg-body rounded printPage" style="width:100%;border:5px solid lightgrey" id="report">
                                    ...
                                    <h6 style="font-weight:500"> Customer Sales Report</h6>
                                    <h6> Customer Name: <strong><?php echo $_GET['cusName']; ?></strong> </h6>
                                    <?php
                                    ...
                                    <div class="report">
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            WHERE customers.customers_name = '$cusName' AND 
                                            delivery_receipt.dr_date
                                            BETWEEN '2023-01-01' AND '2023-03-20'
                                             GROUP BY delivery_receipt.dr_id
