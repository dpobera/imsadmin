    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">EMPLOYEE LIST</h1>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card mt-4 shadow-sm">
                            <h6 class="card-header font-monospace" style="color:grey">ADD NEW EMPLOYEE</h6>
                            <div class="card-body">
                                <div class="alert alert-secondary d-flex align-items-center" role="alert">
                                    ...
                                    <div>
                                        Please check on <strong>EMPLOYEE TABLE</strong> before creating new record !
                                    </div>
                                </div>
                                <form method="POST" action="addrecord/itemInsert/empInsert.php">
                                    ...
                                    <button class="btn btn-secondary bg-gradient btn-sm float-end" name="addEmp">Save Record</button>
                                </form>
                    ...
                    <div class="col-8">
                        <div class="card mb-3 mt-4 shadow-sm">
                            <h6 class="card-header font-monospace" style="color:grey">EMPLOYEE TABLE</h6>
                                ...
                                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                                    <table id="example" class="table table-hover mt-3 table-sm" style="border:solid 1px lightgrey">
                                        <thead class="table-light bg-gradient  sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                                            <th style="color:grey" width="8%">&nbsp;EMPLOYEE ID</th>
                                            <th style="color:grey;" width="30%">EMPLOYEE NAME</th>
