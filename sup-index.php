  ...
  <div class="container-fluid">
    ...
    <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
        <h1 class="h2 text-secondary font-monospace">SUPPLIER</h1>
        ...
        <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
          <table id="example" class="table table-hover  shadow mt-3 table-sm" style="background-color:white;border:1px solid lightgrey">
            <thead class="table-light bg-gradient  sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
              <th style="color:grey" width="8%">&nbsp;SUP ID</th>
              <th style="color:grey;" width="30%">SUPPLIER</th>
              <th style="color:grey" width="20%">ADDRESS</th>
              <th style="color:grey" width="12%">CONTACT PERSON</th>
              <th style="color:grey" width="10%">CONTACT NO.</th>
              <th style="color:grey" width="10%">EMAIL</th>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body bg-light shadow-sm " style="background-color: #ededed;">
          <form autocomplete="off" method="POST" class="form-inline p-3" action="addrecord/itemInsert/supInsert.php">
            <div class="form-floating mb-3 shadow-sm">
              <input type="text" class="form-control" id="floatingInput" name="sup_name" required>
              <label class="text-uppercase" for="floatingInput">Supplier Name</label>
            </div>
            <div class="form-floating mb-3 shadow-sm">
              <input type="text" class="form-control" id="floatingInput" name="sup_conper" required>
            ...
            <div class="form-floating mb-3 shadow-sm">
              <input type="text" class="form-control" id="floatingInput" name="sup_address" required>
            ...
            <div class="form-floating mb-3 shadow-sm">
              ...
              <label class="text-uppercase" for="floatingInput">Email</label>
            </div>
            <div class="form-floating mb-3 shadow-sm">
            ...
            <div class="row mt-4">
              <div class="col"> <button type="submit" class="btn btn-secondary bg-gradient btn-md float-end" name="add_sup">Save Record</button></div>
