    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">RETURN SLIP RECORDS</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        <!-- <button type="button" class="btn btn-sm btn-outline-secondary">Export</button> -->
                        <div class="btnAdd">
                            <a href="addrt.php" class="btn btn-sm btn-secondary bg-gradient">
                                Add New Record</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                    <table id="example" class="table table-hover table-sm" style="background-color:white;border:1px solid lightgrey">
                        <thead class="table-light bg-gradient table-sm sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                            <th style="color:grey;" width="10%">&nbsp;RT ID</th>
                            <th style="color:grey;" width="10%">RT NO.</th>
                            <th style="color:grey" width="40%">CUSTOMER</th>
                            <th style="color:grey" width="10%">
                                <center>DATE</center>
                            </th>
                            <th style="color:grey" width="10%">
