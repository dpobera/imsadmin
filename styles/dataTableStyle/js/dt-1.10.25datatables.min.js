...
(function (k) { "function" === typeof define && define.amd ? define(["jquery"], function (y) { return k(y, window, document) }) : "object" === typeof exports ? module.exports = function (y, z) { y || (y = window); z || (z = "undefined" !== typeof window ? require("jquery") : require("jquery")(y)); return k(z, y, y.document) } : k(jQuery, window, document) })(function (k, y, z, q) {
  ...
  w("clear()", function () { return this.iterator("table", function (a) { Ia(a) }) }); w("settings()", function () { return new C(this.context, this.context) }); w("init()", function () { var a = this.context; return a.length ? a[0].oInit : null }); w("data()", function () { return this.iterator("table", function (a) { return T(a.aoData, "_aData") }).flatten() }); w("destroy()", function (a) {
    ...
    { idx: null, aDataSort: null, asSorting: null, bSearchable: null, bSortable: null, bVisible: null, _sManualType: null, _bAttrSrc: !1, fnCreatedCell: null, fnGetData: null, fnSetData: null, mData: null, mRender: null, nTh: null, nTf: null, sClass: null, sContentPadding: null, sDefaultContent: null, sName: null, sSortDataType: "std", sSortingClass: null, sSortingClassJUI: null, sTitle: null, sType: null, sWidth: null, sWidthOrig: null }; u.defaults = {
      ...
      buttons: {}, classes: {}, builder: "bs5/dt-1.10.25/af-2.3.7/date-1.1.0/r-2.2.9/rg-1.1.3/sc-2.0.4/sp-1.3.0", errMode: "alert", feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: u.fnVersionCheck,
...
*/
(function (f) { "function" === typeof define && define.amd ? define(["jquery"], function (h) { return f(h, window, document) }) : "object" === typeof exports ? module.exports = function (h, x) { h || (h = window); return f(x, h, h.document) } : f(jQuery, window, document) })(function (f, h, x, A) {
  var l, v = function (a, b) {
    "undefined" === typeof l && (l = h.moment ? h.moment : h.dayjs ? h.dayjs : h.luxon ? h.luxon : null); this.c = f.extend(!0, {}, v.defaults, b); b = this.c.classPrefix; var c = this.c.i18n; if (!l && "YYYY-MM-DD" !== this.c.format) throw "DateTime: Without momentjs, dayjs or luxon only the format 'YYYY-MM-DD' can be used";
    "string" === typeof this.c.minDate && (this.c.minDate = new Date(this.c.minDate)); "string" === typeof this.c.maxDate && (this.c.maxDate = new Date(this.c.maxDate)); c = f('<div class="' + b + '"><div class="' + b + '-date"><div class="' + b + '-title"><div class="' + b + '-iconLeft"><button title="' + c.previous + '">' + c.previous + '</button></div><div class="' + b + '-iconRight"><button title="' + c.next + '">' + c.next + '</button></div><div class="' + b + '-label"><span></span><select class="' + b + '-month"></select></div><div class="' + b + '-label"><span></span><select class="' +
      b + '-year"></select></div></div><div class="' + b + '-buttons"><a class="' + b + '-clear">' + c.clear + '</a><a class="' + b + '-today">' + c.today + '</a></div><div class="' + b + '-calendar"></div></div><div class="' + b + '-time"><div class="' + b + '-hours"></div><div class="' + b + '-minutes"></div><div class="' + b + '-seconds"></div></div><div class="' + b + '-error"></div></div>'); this.dom = {
        container: c, date: c.find("." + b + "-date"), title: c.find("." + b + "-title"), calendar: c.find("." + b + "-calendar"), time: c.find("." + b + "-time"), error: c.find("." +
          b + "-error"), buttons: c.find("." + b + "-buttons"), clear: c.find("." + b + "-clear"), today: c.find("." + b + "-today"), input: f(a)
      }; this.s = { d: null, display: null, minutesRange: null, secondsRange: null, namespace: "dateime-" + v._instance++, parts: { date: null !== this.c.format.match(/[YMD]|L(?!T)|l/), time: null !== this.c.format.match(/[Hhm]|LT|LTS/), seconds: -1 !== this.c.format.indexOf("s"), hours12: null !== this.c.format.match(/[haA]/) } }; this.dom.container.append(this.dom.date).append(this.dom.time).append(this.dom.error); this.dom.date.append(this.dom.title).append(this.dom.buttons).append(this.dom.calendar);
    this._constructor()
    ...
    destroy: function () { this._hide(!0); this.dom.container.off().empty(); this.dom.input.removeAttr("autocomplete").off(".datetime") }, errorMsg: function (a) { var b = this.dom.error; a ? b.html(a) : b.empty(); return this }, hide: function () { this._hide(); return this }, max: function (a) { this.c.maxDate = "string" === typeof a ? new Date(a) : a; this._optionsTitle(); this._setCalander(); return this }, min: function (a) {
      this.c.minDate = "string" === typeof a ? new Date(a) : a; this._optionsTitle(); this._setCalander();
      return this
    }, owns: function (a) { return 0 < f(a).parents().filter(this.dom.container).length }, val: function (a, b) {
      if (a === A) return this.s.d; if (a instanceof Date) this.s.d = this._dateToUtc(a); else if (null === a || "" === a) this.s.d = null; else if ("--now" === a) this.s.d = new Date; else if ("string" === typeof a) if (l && l == h.luxon) { var c = l.DateTime.fromFormat(a, this.c.format); this.s.d = c.isValid ? c.toJSDate() : null } else l ? (c = l.utc(a, this.c.format, this.c.locale, this.c.strict), this.s.d = c.isValid() ? c.toDate() : null) : (c = a.match(/(\d{4})\-(\d{2})\-(\d{2})/),
        this.s.d = c ? new Date(Date.UTC(c[1], c[2] - 1, c[3])) : null); if (b || b === A) this.s.d ? this._writeOutput() : this.dom.input.val(a); this.s.display = this.s.d ? new Date(this.s.d.toString()) : new Date; this.s.display.setUTCDate(1); this._setTitle(); this._setCalander(); this._setTime(); return this
    }, _constructor: function () {
      var a = this, b = this.c.classPrefix, c = this.dom.input.val(), g = function () { var d = a.dom.input.val(); d !== c && (a.c.onChange.call(a, d, a.s.d, a.dom.input), c = d) }; this.s.parts.date || this.dom.date.css("display", "none");
      this.s.parts.time || this.dom.time.css("display", "none"); this.s.parts.seconds || (this.dom.time.children("div." + b + "-seconds").remove(), this.dom.time.children("span").eq(1).remove()); this.c.buttons.clear || this.dom.clear.css("display", "none"); this.c.buttons.today || this.dom.today.css("display", "none"); this._optionsTitle(); f(x).on("i18n.dt", function (d, e) { e.oLanguage.datetime && (f.extend(!0, a.c.i18n, e.oLanguage.datetime), this._optionsTitle()) }); "hidden" === this.dom.input.attr("type") && (this.dom.container.addClass("inline"),
        this.c.attachTo = "input", this.val(this.dom.input.val(), !1), this._show()); c && this.val(c, !1); this.dom.input.attr("autocomplete", "off").on("focus.datetime click.datetime", function () { a.dom.container.is(":visible") || a.dom.input.is(":disabled") || (a.val(a.dom.input.val(), !1), a._show()) }).on("keyup.datetime", function () { a.dom.container.is(":visible") && a.val(a.dom.input.val(), !1) }); this.dom.container.on("change", "select", function () {
          var d = f(this), e = d.val(); d.hasClass(b + "-month") ? (a._correctMonth(a.s.display,
            e), a._setTitle(), a._setCalander()) : d.hasClass(b + "-year") ? (a.s.display.setUTCFullYear(e), a._setTitle(), a._setCalander()) : d.hasClass(b + "-hours") || d.hasClass(b + "-ampm") ? (a.s.parts.hours12 ? (d = 1 * f(a.dom.container).find("." + b + "-hours").val(), e = "pm" === f(a.dom.container).find("." + b + "-ampm").val(), a.s.d.setUTCHours(12 !== d || e ? e && 12 !== d ? d + 12 : d : 0)) : a.s.d.setUTCHours(e), a._setTime(), a._writeOutput(!0), g()) : d.hasClass(b + "-minutes") ? (a.s.d.setUTCMinutes(e), a._setTime(), a._writeOutput(!0), g()) : d.hasClass(b + "-seconds") &&
              (a.s.d.setSeconds(e), a._setTime(), a._writeOutput(!0), g()); a.dom.input.focus(); a._position()
        }).on("click", function (d) {
          var e = a.s.d; e = d.target.nodeName.toLowerCase(); var n = "span" === e ? d.target.parentNode : d.target; e = n.nodeName.toLowerCase(); if ("select" !== e) if (d.stopPropagation(), "a" === e && (d.preventDefault(), f(n).hasClass(b + "-clear") ? (a.s.d = null, a.dom.input.val(""), a._writeOutput(), a._setCalander(), a._setTime(), g()) : f(n).hasClass(b + "-today") && (a.s.display = new Date, a._setTitle(), a._setCalander())), "button" ===
            e) {
              var m = f(n); d = m.parent(); if (d.hasClass("disabled") && !d.hasClass("range")) m.blur(); else if (d.hasClass(b + "-iconLeft")) a.s.display.setUTCMonth(a.s.display.getUTCMonth() - 1), a._setTitle(), a._setCalander(), a.dom.input.focus(); else if (d.hasClass(b + "-iconRight")) a._correctMonth(a.s.display, a.s.display.getUTCMonth() + 1), a._setTitle(), a._setCalander(), a.dom.input.focus(); else {
                if (m.parents("." + b + "-time").length) {
                  n = m.data("value"); m = m.data("unit"); e = a._needValue(); if ("minutes" === m) {
                    if (d.hasClass("disabled") &&
                      d.hasClass("range")) { a.s.minutesRange = n; a._setTime(); return } a.s.minutesRange = null
                  } if ("seconds" === m) { if (d.hasClass("disabled") && d.hasClass("range")) { a.s.secondsRange = n; a._setTime(); return } a.s.secondsRange = null } if ("am" === n) if (12 <= e.getUTCHours()) n = e.getUTCHours() - 12; else return; else if ("pm" === n) if (12 > e.getUTCHours()) n = e.getUTCHours() + 12; else return; e["hours" === m ? "setUTCHours" : "minutes" === m ? "setUTCMinutes" : "setSeconds"](n); a._setTime(); a._writeOutput(!0)
                } else e = a._needValue(), e.setUTCDate(1), e.setUTCFullYear(m.data("year")),
                  e.setUTCMonth(m.data("month")), e.setUTCDate(m.data("day")), a._writeOutput(!0), a.s.parts.time ? a._setCalander() : setTimeout(function () { a._hide() }, 10); g()
              }
          } else a.dom.input.focus()
        })
    }, _compareDates: function (a, b) { return l && l == h.luxon ? l.DateTime.fromJSDate(a).toISODate() === l.DateTime.fromJSDate(b).toISODate() : this._dateToUtcString(a) === this._dateToUtcString(b) }, _correctMonth: function (a, b) { var c = this._daysInMonth(a.getUTCFullYear(), b), g = a.getUTCDate() > c; a.setUTCMonth(b); g && (a.setUTCDate(c), a.setUTCMonth(b)) },
    _daysInMonth: function (a, b) { return [31, 0 !== a % 4 || 0 === a % 100 && 0 !== a % 400 ? 28 : 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][b] }, _dateToUtc: function (a) { return new Date(Date.UTC(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds())) }, _dateToUtcString: function (a) { return l && l == h.luxon ? l.DateTime.fromJSDate(a).toISODate() : a.getUTCFullYear() + "-" + this._pad(a.getUTCMonth() + 1) + "-" + this._pad(a.getUTCDate()) }, _hide: function (a) {
      if (a || "hidden" !== this.dom.input.attr("type")) a = this.s.namespace, this.dom.container.detach(),
        f(h).off("." + a), f(x).off("keydown." + a), f("div.dataTables_scrollBody").off("scroll." + a), f("div.DTE_Body_Content").off("scroll." + a), f("body").off("click." + a)
    }, _hours24To12: function (a) { return 0 === a ? 12 : 12 < a ? a - 12 : a }, _htmlDay: function (a) {
      if (a.empty) return '<td class="empty"></td>'; var b = ["selectable"], c = this.c.classPrefix; a.disabled && b.push("disabled"); a.today && b.push("now"); a.selected && b.push("selected"); return '<td data-day="' + a.day + '" class="' + b.join(" ") + '"><button class="' + c + "-button " + c + '-day" type="button" data-year="' +
        a.year + '" data-month="' + a.month + '" data-day="' + a.day + '"><span>' + a.day + "</span></button></td>"
    }, _htmlMonth: function (a, b) {
      var c = this._dateToUtc(new Date), g = this._daysInMonth(a, b), d = (new Date(Date.UTC(a, b, 1))).getUTCDay(), e = [], n = []; 0 < this.c.firstDay && (d -= this.c.firstDay, 0 > d && (d += 7)); for (var m = g + d, q = m; 7 < q;)q -= 7; m += 7 - q; var t = this.c.minDate; q = this.c.maxDate; t && (t.setUTCHours(0), t.setUTCMinutes(0), t.setSeconds(0)); q && (q.setUTCHours(23), q.setUTCMinutes(59), q.setSeconds(59)); for (var k = 0, p = 0; k < m; k++) {
        var u =
          new Date(Date.UTC(a, b, 1 + (k - d))), z = this.s.d ? this._compareDates(u, this.s.d) : !1, r = this._compareDates(u, c), B = k < d || k >= g + d, y = t && u < t || q && u > q, w = this.c.disableDays; Array.isArray(w) && -1 !== f.inArray(u.getUTCDay(), w) ? y = !0 : "function" === typeof w && !0 === w(u) && (y = !0); n.push(this._htmlDay({ day: 1 + (k - d), month: b, year: a, selected: z, today: r, disabled: y, empty: B })); 7 === ++p && (this.c.showWeekNumber && n.unshift(this._htmlWeekOfYear(k - d, b, a)), e.push("<tr>" + n.join("") + "</tr>"), n = [], p = 0)
      } c = this.c.classPrefix; g = c + "-table"; this.c.showWeekNumber &&
        (g += " weekNumber"); t && (t = t >= new Date(Date.UTC(a, b, 1, 0, 0, 0)), this.dom.title.find("div." + c + "-iconLeft").css("display", t ? "none" : "block")); q && (a = q < new Date(Date.UTC(a, b + 1, 1, 0, 0, 0)), this.dom.title.find("div." + c + "-iconRight").css("display", a ? "none" : "block")); return '<table class="' + g + '"><thead>' + this._htmlMonthHead() + "</thead><tbody>" + e.join("") + "</tbody></table>"
    }, _htmlMonthHead: function () {
      var a = [], b = this.c.firstDay, c = this.c.i18n, g = function (e) { for (e += b; 7 <= e;)e -= 7; return c.weekdays[e] }; this.c.showWeekNumber &&
        a.push("<th></th>"); for (var d = 0; 7 > d; d++)a.push("<th>" + g(d) + "</th>"); return a.join("")
    }, _htmlWeekOfYear: function (a, b, c) { a = new Date(c, b, a, 0, 0, 0, 0); a.setDate(a.getDate() + 4 - (a.getDay() || 7)); return '<td class="' + this.c.classPrefix + '-week">' + Math.ceil(((a - new Date(c, 0, 1)) / 864E5 + 1) / 7) + "</td>" }, _needValue: function () { this.s.d || (this.s.d = this._dateToUtc(new Date)); return this.s.d }, _options: function (a, b, c) {
      c || (c = b); a = this.dom.container.find("select." + this.c.classPrefix + "-" + a); a.empty(); for (var g = 0, d = b.length; g <
        d; g++)a.append('<option value="' + b[g] + '">' + c[g] + "</option>")
    }, _optionSet: function (a, b) { var c = this.dom.container.find("select." + this.c.classPrefix + "-" + a); a = c.parent().children("span"); c.val(b); b = c.find("option:selected"); a.html(0 !== b.length ? b.text() : this.c.i18n.unknown) }, _optionsTime: function (a, b, c, g, d) {
      var e = this.c.classPrefix, n = this.dom.container.find("div." + e + "-" + a), m = 12 === b ? function (r) { return r } : this._pad; e = this.c.classPrefix; var q = e + "-table", t = this.c.i18n; if (n.length) {
        var k = ""; var p = 10; var u =
          function (r, B, y) { 12 === b && "number" === typeof r && (12 <= c && (r += 12), 12 == r ? r = 0 : 24 == r && (r = 12)); var w = c === r || "am" === r && 12 > c || "pm" === r && 12 <= c ? "selected" : ""; g && -1 === f.inArray(r, g) && (w += " disabled"); y && (w += " " + y); return '<td class="selectable ' + w + '"><button class="' + e + "-button " + e + '-day" type="button" data-unit="' + a + '" data-value="' + r + '"><span>' + B + "</span></button></td>" }; if (12 === b) {
            k += "<tr>"; for (d = 1; 6 >= d; d++)k += u(d, m(d)); k += u("am", t.amPm[0]); k += "</tr><tr>"; for (d = 7; 12 >= d; d++)k += u(d, m(d)); k += u("pm", t.amPm[1]); k +=
              "</tr>"; p = 7
          } else { if (24 === b) { var z = 0; for (p = 0; 4 > p; p++) { k += "<tr>"; for (d = 0; 6 > d; d++)k += u(z, m(z)), z++; k += "</tr>" } } else { k += "<tr>"; for (p = 0; 60 > p; p += 10)k += u(p, m(p), "range"); d = null !== d ? d : 10 * Math.floor(c / 10); k = k + '</tr></tbody></thead><table class="' + (q + " " + q + '-nospace"><tbody><tr>'); for (p = d + 1; p < d + 10; p++)k += u(p, m(p)); k += "</tr>" } p = 6 } n.empty().append('<table class="' + q + '"><thead><tr><th colspan="' + p + '">' + t[a] + "</th></tr></thead><tbody>" + k + "</tbody></table>")
      }
    }, _optionsTitle: function () {
      var a = this.c.i18n, b = this.c.minDate,
      c = this.c.maxDate; b = b ? b.getFullYear() : null; c = c ? c.getFullYear() : null; b = null !== b ? b : (new Date).getFullYear() - this.c.yearRange; c = null !== c ? c : (new Date).getFullYear() + this.c.yearRange; this._options("month", this._range(0, 11), a.months); this._options("year", this._range(b, c))
    }, _pad: function (a) { return 10 > a ? "0" + a : a }, _position: function () {
      var a = "input" === this.c.attachTo ? this.dom.input.position() : this.dom.input.offset(), b = this.dom.container, c = this.dom.input.outerHeight(); if (b.hasClass("inline")) b.insertAfter(this.dom.input);
      else { this.s.parts.date && this.s.parts.time && 550 < f(h).width() ? b.addClass("horizontal") : b.removeClass("horizontal"); "input" === this.c.attachTo ? b.css({ top: a.top + c, left: a.left }).insertAfter(this.dom.input) : b.css({ top: a.top + c, left: a.left }).appendTo("body"); var g = b.outerHeight(), d = b.outerWidth(), e = f(h).scrollTop(); a.top + c + g - e > f(h).height() && (c = a.top - g, b.css("top", 0 > c ? 0 : c)); d + a.left > f(h).width() && (a = f(h).width() - d, "input" === this.c.attachTo && (a -= f(b).offsetParent().offset().left), b.css("left", 0 > a ? 0 : a)) }
    }, _range: function (a,
      b, c) { var g = []; for (c || (c = 1); a <= b; a += c)g.push(a); return g }, _setCalander: function () { this.s.display && this.dom.calendar.empty().append(this._htmlMonth(this.s.display.getUTCFullYear(), this.s.display.getUTCMonth())) }, _setTitle: function () { this._optionSet("month", this.s.display.getUTCMonth()); this._optionSet("year", this.s.display.getUTCFullYear()) }, _setTime: function () {
        var a = this, b = this.s.d, c = null; l && l == h.luxon && (c = l.DateTime.fromJSDate(b)); var g = null != c ? c.hour : b ? b.getUTCHours() : 0, d = function (e) {
          return a.c[e +
            "Available"] ? a.c[e + "Available"] : a._range(0, 59, a.c[e + "Increment"])
        }; this._optionsTime("hours", this.s.parts.hours12 ? 12 : 24, g, this.c.hoursAvailable); this._optionsTime("minutes", 60, null != c ? c.minute : b ? b.getUTCMinutes() : 0, d("minutes"), this.s.minutesRange); this._optionsTime("seconds", 60, null != c ? c.second : b ? b.getSeconds() : 0, d("seconds"), this.s.secondsRange)
      }, _show: function () {
        var a = this, b = this.s.namespace; this._position(); f(h).on("scroll." + b + " resize." + b, function () { a._position() }); f("div.DTE_Body_Content").on("scroll." +
          b, function () { a._position() }); f("div.dataTables_scrollBody").on("scroll." + b, function () { a._position() }); var c = this.dom.input[0].offsetParent; if (c !== x.body) f(c).on("scroll." + b, function () { a._position() }); f(x).on("keydown." + b, function (g) { 9 !== g.keyCode && 27 !== g.keyCode && 13 !== g.keyCode || a._hide() }); setTimeout(function () { f("body").on("click." + b, function (g) { f(g.target).parents().filter(a.dom.container).length || g.target === a.dom.input[0] || a._hide() }) }, 10)
      }, _writeOutput: function (a) {
        var b = this.s.d, c = ""; b && (c = l &&
  ...
  }); v.use = function (a) { l = a }; v._instance = 0; v.defaults = {
    attachTo: "body", buttons: { clear: !1, today: !1 }, classPrefix: "dt-datetime", disableDays: null, firstDay: 1, format: "YYYY-MM-DD",
...
*/
(function (e) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (h) { return e(h, window, document) }) : "object" === typeof exports ? module.exports = function (h, m) { h || (h = window); m && m.fn.dataTable || (m = require("datatables.net")(h, m).$); return e(m, h, h.document) } : e(jQuery, window, document) })(function (e, h, m, q) {
  var u = e.fn.dataTable, k = function (a, b) {
    this instanceof k ? (b === q && (b = {}), a = e.fn.dataTable.Api(a), this.s = {
    ...
    }, this.s = e.extend(this.s, k.oDefaults, b), this.s.heights.row = this.s.rowHeight, this.dom = { force: m.createElement("div"), label: e('<div class="dts_label">0</div>'), scroller: null, table: null, loader: null },
    ...
    measure: function (a) {
      this.s.autoHeight && this._calcRowHeight(); var b = this.s.heights; b.row && (b.viewport = this._parseHeight(e(this.dom.scroller).css("max-height")), this.s.viewportRows = parseInt(b.viewport / b.row, 10) + 1, this.s.dt._iDisplayLength = this.s.viewportRows * this.s.displayBuffer); var c = this.dom.label.outerHeight(), d = this.dom.scroller.offsetHeight -
        this.dom.scroller.clientHeight; b.labelHeight = c; b.labelFactor = (b.viewport - c - d) / b.scroll; (a === q || a) && this.s.dt.oInstance.fnDraw(!1)
      ...
      a -= this.s.baseScrollTop; c = c ? (this._domain("physicalToVirtual", this.s.baseScrollTop) + a) / this.s.heights.row : a / this.s.heights.row +
        this.s.baseRowTop; return b || b === q ? parseInt(c, 10) : c
    }, rowToPixels: function (a, b, c) { a -= this.s.baseRowTop; c = c ? this._domain("virtualToPhysical", this.s.baseScrollTop) : this.s.baseScrollTop; c += a * this.s.heights.row; return b || b === q ? parseInt(c, 10) : c }, scrollToRow: function (a, b) {
      var c = this, d = !1, f = this.rowToPixels(a), g = a - (this.s.displayBuffer - 1) / 2 * this.s.viewportRows; 0 > g && (g = 0); (f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== g && (d = !0, f = this._domain("virtualToPhysical", a * this.s.heights.row),
        this.s.redrawTop < f && f < this.s.redrawBottom && (this.s.forceReposition = !0, b = !1)); b === q || b ? (this.s.ani = d, e(this.dom.scroller).animate({ scrollTop: f }, function () { setTimeout(function () { c.s.ani = !1 }, 250) })) : e(this.dom.scroller).scrollTop(f)
    }, construct: function () {
      var a = this, b = this.s.dtApi; if (this.s.dt.oFeatures.bPaginate) {
        this.dom.force.style.position = "relative"; this.dom.force.style.top = "0px"; this.dom.force.style.left = "0px"; this.dom.force.style.width = "1px"; this.dom.scroller = e("div." + this.s.dt.oClasses.sScrollBody,
          this.s.dt.nTableWrapper)[0]; this.dom.scroller.appendChild(this.dom.force); this.dom.scroller.style.position = "relative"; this.dom.table = e(">table", this.dom.scroller)[0]; this.dom.table.style.position = "absolute"; this.dom.table.style.top = "0px"; this.dom.table.style.left = "0px"; e(b.table().container()).addClass("dts DTS"); this.s.loadingIndicator && (this.dom.loader = e('<div class="dataTables_processing dts_loading">' + this.s.dt.oLanguage.sLoadingRecords + "</div>").css("display", "none"), e(this.dom.scroller.parentNode).css("position",
            "relative").append(this.dom.loader)); this.dom.label.appendTo(this.dom.scroller); this.s.heights.row && "auto" != this.s.heights.row && (this.s.autoHeight = !1); this.s.ingnoreScroll = !0; e(this.dom.scroller).on("scroll.dt-scroller", function (f) { a._scroll.call(a) }); e(this.dom.scroller).on("touchstart.dt-scroller", function () { a._scroll.call(a) }); e(this.dom.scroller).on("mousedown.dt-scroller", function () { a.s.mousedown = !0 }).on("mouseup.dt-scroller", function () {
              a.s.labelVisible = !1; a.s.mousedown = !1; a.dom.label.css("display",
                "none")
              ...
              500); b.on("init.scroller", function () { a.measure(!1); a.s.scrollType = "jump"; a._draw(); b.on("draw.scroller", function () { a._draw() }) }); b.on("preDraw.dt.scroller", function () { a._scrollForce() }); b.on("destroy.scroller", function () {
                e(h).off("resize.dt-scroller"); e(a.dom.scroller).off(".dt-scroller"); e(a.s.dt.nTable).off(".scroller"); e(a.s.dt.nTableWrapper).removeClass("DTS"); e("div.DTS_Loading", a.dom.scroller.parentNode).remove(); a.dom.table.style.position = ""; a.dom.table.style.top = ""; a.dom.table.style.left =
                  ""
              })
      ...
      e("div." + a.oClasses.sScrollBody, f).append(c); a = this.s.dt.nHolding || b.parentNode; e(a).is(":visible") || (a = "body"); f.find("input").removeAttr("name"); f.appendTo(a); this.s.heights.row = e("tr", d).eq(1).outerHeight(); f.remove()
    }, _draw: function () {
      var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop, d = e(this.s.dt.nTable).height(), f = this.s.dt._iDisplayStart, g = this.s.dt._iDisplayLength, l = this.s.dt.fnRecordsDisplay(); this.s.skip = !0; !this.s.dt.bSorted && !this.s.dt.bFiltered || 0 !== f || this.s.dt._drawHold || (this.s.topRowFloat =
        0); c = "jump" === this.s.scrollType ? this._domain("virtualToPhysical", this.s.topRowFloat * b.row) : c; this.s.baseScrollTop = c; this.s.baseRowTop = this.s.topRowFloat; var n = c - (this.s.topRowFloat - f) * b.row; 0 === f ? n = 0 : f + g >= l && (n = b.scroll - d); this.dom.table.style.top = n + "px"; this.s.tableTop = n; this.s.tableBottom = d + this.s.tableTop; d = (c - this.s.tableTop) * this.s.boundaryScale; this.s.redrawTop = c - d; this.s.redrawBottom = c + d > b.scroll - b.viewport - b.row ? b.scroll - b.viewport - b.row : c + d; this.s.skip = !1; this.s.dt.oFeatures.bStateSave &&
          null !== this.s.dt.oLoadedState && "undefined" != typeof this.s.dt.oLoadedState.scroller ? ((b = !this.s.dt.sAjaxSource && !a.s.dt.ajax || this.s.dt.oFeatures.bServerSide ? !1 : !0) && 2 == this.s.dt.iDraw || !b && 1 == this.s.dt.iDraw) && setTimeout(function () { e(a.dom.scroller).scrollTop(a.s.dt.oLoadedState.scroller.scrollTop); setTimeout(function () { a.s.ingnoreScroll = !1 }, 0) }, 0) : a.s.ingnoreScroll = !1; this.s.dt.oFeatures.bInfo && setTimeout(function () { a._info.call(a) }, 0); e(this.s.dt.nTable).triggerHandler("position.dts.dt", n); this.dom.loader &&
            this.s.loaderVisible && (this.dom.loader.css("display", "none"), this.s.loaderVisible = !1)
      ...
      var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop; if (!this.s.skip && !this.s.ingnoreScroll && c !== this.s.lastScrollTop) if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0; else {
        ...
        this.s.stateTO = setTimeout(function () { a.s.dtApi.state.save() }, 250); this.s.scrollType = Math.abs(c - this.s.lastScrollTop) > b.viewport ? "jump" : "cont"; this.s.topRowFloat = "cont" === this.s.scrollType ? this.pixelsToRow(c, !1, !1) : this._domain("physicalToVirtual", c) / b.row; 0 > this.s.topRowFloat && (this.s.topRowFloat = 0); if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
          var d = Math.ceil((this.s.displayBuffer - 1) / 2 * this.s.viewportRows); d = parseInt(this.s.topRowFloat, 10) - d; this.s.forceReposition = !1; 0 >= d ?
            d = 0 : d + this.s.dt._iDisplayLength > this.s.dt.fnRecordsDisplay() ? (d = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength, 0 > d && (d = 0)) : 0 !== d % 2 && d++; this.s.targetTop = d; d != this.s.dt._iDisplayStart && (this.s.tableTop = e(this.s.dt.nTable).offset().top, this.s.tableBottom = e(this.s.dt.nTable).height() + this.s.tableTop, d = function () { a.s.dt._iDisplayStart = a.s.targetTop; a.s.dt.oApi._fnDraw(a.s.dt) }, this.s.dt.oFeatures.bServerSide ? (this.s.forceReposition = !0, clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(d, this.s.serverWait)) :
              d(), this.dom.loader && !this.s.loaderVisible && (this.dom.loader.css("display", "block"), this.s.loaderVisible = !0))
...
*/
(function () {
  function G(n) { l = n; A = n.fn.dataTable } function H(n) { p = n; B = n.fn.dataTable } var l, A, E = function () {
    function n(a, b, f, c, e, d) {
      var g = this; void 0 === d && (d = null); if (!A || !A.versionCheck || !A.versionCheck("1.10.0")) throw Error("SearchPane requires DataTables 1.10 or newer"); if (!A.select) throw Error("SearchPane requires Select"); a = new A.Api(a); this.classes = l.extend(!0, {}, n.classes); this.c = l.extend(!0, {}, n.defaults, b); void 0 !== b && void 0 !== b.hideCount && void 0 === b.viewCount && (this.c.viewCount = !this.c.hideCount);
      ...
      this.colExists = this.s.index < b; this.c.layout = c; b = parseInt(c.split("-")[1], 10); this.dom = {
        ...
        dtP: l("<table><thead><tr><th>" + (this.colExists ? l(a.column(this.colExists ? this.s.index : 0).header()).text() : this.customPaneSettings.header || "Custom Pane") + "</th><th/></tr></thead></table>"), lower: l("<div/>").addClass(this.classes.subRow2).addClass(this.classes.narrowButton), nameButton: l('<button type="button"></button>').addClass(this.classes.paneButton).addClass(this.classes.nameButton), panesContainer: e, searchBox: l("<input/>").addClass(this.classes.paneInputButton).addClass(this.classes.search), searchButton: l('<button type = "button" class="' +
          this.classes.searchIcon + '"></button>').addClass(this.classes.paneButton), searchCont: l("<div/>").addClass(this.classes.searchCont), searchLabelCont: l("<div/>").addClass(this.classes.searchLabelCont), topRow: l("<div/>").addClass(this.classes.topRow), upper: l("<div/>").addClass(this.classes.subRow1).addClass(this.classes.narrowSearch)
      }; this.s.displayed = !1; a = this.s.dt; this.selections = []; this.s.colOpts = this.colExists ? this._getOptions() : this._getBonusOptions(); var h = this.s.colOpts; c = l('<button type="button">X</button>').addClass(this.classes.paneButton);
      ...
      l(e).append(this.dom.container); var m = a.table(0).node(); this.s.searchFunction = function (k, r, v, t) { if (0 === g.selections.length || k.nTable !== m) return !0; k = null; g.colExists && (k = r[g.s.index], "filter" !== h.orthogonal.filter && (k = g.s.rowData.filterMap.get(v), k instanceof l.fn.dataTable.Api && (k = k.toArray()))); return g._search(k, v) }; l.fn.dataTable.ext.search.push(this.s.searchFunction); if (this.c.clear) l(c).on("click", function () {
        g.dom.container.find("." + g.classes.search.replace(/\s+/g, ".")).each(function () {
          l(this).val("");
          l(this).trigger("input")
        }); g.clearPane()
      }); a.on("draw.dtsp", function () { g.adjustTopRow() }); a.on("buttons-action", function () { g.adjustTopRow() }); a.on("column-reorder.dtsp", function (k, r, v) { g.s.index = v.mapping[g.s.index] }); return this
    } n.prototype.addRow = function (a, b, f, c, e, d, g) {
      for (var h, m = 0, k = this.s.indexes; m < k.length; m++) { var r = k[m]; r.filter === b && (h = r.index) } void 0 === h && (h = this.s.indexes.length, this.s.indexes.push({ filter: b, index: h })); return this.s.dtPane.row.add({
        className: g, display: "" !== a ? a : this.emptyMessage(),
        filter: b, index: h, shown: f, sort: e, total: c, type: d
      })
    }; n.prototype.adjustTopRow = function () {
      var a = this.dom.container.find("." + this.classes.subRowsContainer.replace(/\s+/g, ".")), b = this.dom.container.find("." + this.classes.subRow1.replace(/\s+/g, ".")), f = this.dom.container.find("." + this.classes.subRow2.replace(/\s+/g, ".")), c = this.dom.container.find("." + this.classes.topRow.replace(/\s+/g, ".")); (252 > l(a[0]).width() || 252 > l(c[0]).width()) && 0 !== l(a[0]).width() ? (l(a[0]).addClass(this.classes.narrow), l(b[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowSearch),
        l(f[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowButton)) : (l(a[0]).removeClass(this.classes.narrow), l(b[0]).removeClass(this.classes.narrowSub).addClass(this.classes.narrowSearch), l(f[0]).removeClass(this.classes.narrowSub).addClass(this.classes.narrowButton))
    }; n.prototype.clearData = function () { this.s.rowData = { arrayFilter: [], arrayOriginal: [], arrayTotals: [], bins: {}, binsOriginal: {}, binsTotal: {}, filterMap: new Map, totalOptions: 0 } }; n.prototype.clearPane = function () {
      this.s.dtPane.rows({ selected: !0 }).deselect();
      this.updateTable(); return this
    }; n.prototype.destroy = function () {
      l(this.s.dtPane).off(".dtsp"); l(this.s.dt).off(".dtsp"); l(this.dom.nameButton).off(".dtsp"); l(this.dom.countButton).off(".dtsp"); l(this.dom.clear).off(".dtsp"); l(this.dom.searchButton).off(".dtsp"); l(this.dom.container).remove(); for (var a = l.fn.dataTable.ext.search.indexOf(this.s.searchFunction); -1 !== a;)l.fn.dataTable.ext.search.splice(a, 1), a = l.fn.dataTable.ext.search.indexOf(this.s.searchFunction); void 0 !== this.s.dtPane && this.s.dtPane.destroy();
      this.s.listSet = !1
    }; n.prototype.emptyMessage = function () { var a = this.c.i18n.emptyMessage; this.c.emptyMessage && (a = this.c.emptyMessage); !1 !== this.s.colOpts.emptyMessage && null !== this.s.colOpts.emptyMessage && (a = this.s.colOpts.emptyMessage); return this.s.dt.i18n("searchPanes.emptyMessage", a) }; n.prototype.getPaneCount = function () { return void 0 !== this.s.dtPane ? this.s.dtPane.rows({ selected: !0 }).data().toArray().length : 0 }; n.prototype.rebuildPane = function (a, b, f, c) {
      void 0 === a && (a = !1); void 0 === b && (b = null); void 0 ===
        f && (f = null); void 0 === c && (c = !1); this.clearData(); var e = []; this.s.serverSelect = []; var d = null; void 0 !== this.s.dtPane && (c && (this.s.dt.page.info().serverSide ? this.s.serverSelect = this.s.dtPane.rows({ selected: !0 }).data().toArray() : e = this.s.dtPane.rows({ selected: !0 }).data().toArray()), this.s.dtPane.clear().destroy(), d = l(this.dom.container).prev(), this.destroy(), this.s.dtPane = void 0, l.fn.dataTable.ext.search.push(this.s.searchFunction)); this.dom.container.removeClass(this.classes.hidden); this.s.displayed =
          !1; this._buildPane(this.s.dt.page.info().serverSide ? this.s.serverSelect : e, a, b, f, d); return this
    }; n.prototype.removePane = function () { this.s.displayed = !1; l(this.dom.container).hide() }; n.prototype.resize = function (a) {
      this.c.layout = a; var b = parseInt(a.split("-")[1], 10); l(this.dom.container).removeClass().addClass(this.classes.container).addClass(this.classes.layout + (10 > b ? a : a.split("-")[0] + "-9")).addClass(this.s.colOpts.className).addClass(null !== this.customPaneSettings && void 0 !== this.customPaneSettings.className ?
        this.customPaneSettings.className : "").addClass(this.classes.show); this.adjustTopRow()
      ...
      function () {
        var a = this, b = this.s.rowData, f; this.s.dtPane.on("select.dtsp", function () { clearTimeout(f); a.s.dt.page.info().serverSide && !a.s.updating ? a.s.serverSelecting || (a.s.serverSelect = a.s.dtPane.rows({ selected: !0 }).data().toArray(), a.s.scrollTop = l(a.s.dtPane.table().node()).parent()[0].scrollTop, a.s.selectPresent = !0, a.s.dt.draw(!1)) : (l(a.dom.clear).removeClass(a.classes.disabledButton).removeAttr("disabled"), a.s.updating || (a.s.selectPresent = !0, a._makeSelection(), a.s.selectPresent = !1)) }); this.s.dtPane.on("deselect.dtsp",
          function () { f = setTimeout(function () { a.s.dt.page.info().serverSide && !a.s.updating ? a.s.serverSelecting || (a.s.serverSelect = a.s.dtPane.rows({ selected: !0 }).data().toArray(), a.s.deselect = !0, a.s.dt.draw(!1)) : (a.s.deselect = !0, 0 === a.s.dtPane.rows({ selected: !0 }).data().toArray().length && l(a.dom.clear).addClass(a.classes.disabledButton).attr("disabled", "true"), a._makeSelection(), a.s.deselect = !1, a.s.dt.state.save()) }, 50) }); this.s.dt.on("stateSaveParams.dtsp", function (c, e, d) {
            if (l.isEmptyObject(d)) a.s.dtPane.state.clear();
            else {
              c = []; if (void 0 !== a.s.dtPane) { c = a.s.dtPane.rows({ selected: !0 }).data().map(function (r) { return r.filter.toString() }).toArray(); var g = l(a.dom.searchBox).val(); var h = a.s.dtPane.order(); var m = b.binsOriginal; var k = b.arrayOriginal } void 0 === d.searchPanes && (d.searchPanes = {}); void 0 === d.searchPanes.panes && (d.searchPanes.panes = []); for (e = 0; e < d.searchPanes.panes.length; e++)d.searchPanes.panes[e].id === a.s.index && (d.searchPanes.panes.splice(e, 1), e--); d.searchPanes.panes.push({
                arrayFilter: k, bins: m, id: a.s.index,
                order: h, searchTerm: g, selected: c
              })
            }
          }); this.s.dtPane.on("user-select.dtsp", function (c, e, d, g, h) { h.stopPropagation() }); this.s.dtPane.on("draw.dtsp", function () { a.adjustTopRow() }); l(this.dom.nameButton).on("click.dtsp", function () { var c = a.s.dtPane.order()[0][1]; a.s.dtPane.order([0, "asc" === c ? "desc" : "asc"]).draw(); a.s.dt.state.save() }); l(this.dom.countButton).on("click.dtsp", function () { var c = a.s.dtPane.order()[0][1]; a.s.dtPane.order([1, "asc" === c ? "desc" : "asc"]).draw(); a.s.dt.state.save() }); l(this.dom.clear).on("click.dtsp",
            function () { a.dom.container.find("." + a.classes.search.replace(/ /g, ".")).each(function () { l(this).val(""); l(this).trigger("input") }); a.clearPane() }); l(this.dom.searchButton).on("click.dtsp", function () { l(a.dom.searchBox).focus() }); l(this.dom.searchBox).on("input.dtsp", function () {
              var c = l(a.dom.searchBox).val(); a.s.dtPane.search(c).draw(); 0 < c.length || 0 === c.length && 0 < a.s.dtPane.rows({ selected: !0 }).data().toArray().length ? a.dom.clear.removeClass(a.classes.disabledButton).removeAttr("disabled") : a.dom.clear.addClass(a.classes.disabledButton).attr("disabled",
                "true"); a.s.dt.state.save()
            }); this.s.dt.state.save(); return !0
      }; n.prototype._addOption = function (a, b, f, c, e, d) {
        if (Array.isArray(a) || a instanceof A.Api) if (a instanceof A.Api && (a = a.toArray(), b = b.toArray()), a.length === b.length) for (var g = 0; g < a.length; g++)d[a[g]] ? d[a[g]]++ : (d[a[g]] = 1, e.push({ display: b[g], filter: a[g], sort: f[g], type: c[g] })), this.s.rowData.totalOptions++; else throw Error("display and filter not the same length"); else "string" === typeof this.s.colOpts.orthogonal ? (d[a] ? d[a]++ : (d[a] = 1, e.push({
          display: b,
          filter: a, sort: f, type: c
        })), this.s.rowData.totalOptions++) : e.push({ display: b, filter: a, sort: f, type: c })
      }; n.prototype._buildPane = function (a, b, f, c, e) {
        var d = this; void 0 === a && (a = []); void 0 === b && (b = !1); void 0 === f && (f = null); void 0 === c && (c = null); void 0 === e && (e = null); this.selections = []; var g = this.s.dt, h = g.column(this.colExists ? this.s.index : 0), m = this.s.colOpts, k = this.s.rowData, r = g.i18n("searchPanes.count", this.c.i18n.count), v = g.i18n("searchPanes.countFiltered", this.c.i18n.countFiltered), t = g.state.loaded(); this.s.listSet &&
          (t = g.state()); if (this.colExists) {
            var u = -1; if (t && t.searchPanes && t.searchPanes.panes) for (var q = 0; q < t.searchPanes.panes.length; q++)if (t.searchPanes.panes[q].id === this.s.index) { u = q; break } if ((!1 === m.show || void 0 !== m.show && !0 !== m.show) && -1 === u) return this.dom.container.addClass(this.classes.hidden), this.s.displayed = !1; if (!0 === m.show || -1 !== u) this.s.displayed = !0; if (!this.s.dt.page.info().serverSide && (null === f || null === f.searchPanes || null === f.searchPanes.options)) {
              if (0 === k.arrayFilter.length) {
                this._populatePane(b);
                this.s.rowData.totalOptions = 0; this._detailsPane(); if (t && t.searchPanes && t.searchPanes.panes && -1 === u) { this.dom.container.addClass(this.classes.hidden); this.s.displayed = !1; return } k.arrayOriginal = k.arrayTotals; k.binsOriginal = k.binsTotal
              } q = Object.keys(k.binsOriginal).length; b = this._uniqueRatio(q, g.rows()[0].length); if (!1 === this.s.displayed && ((void 0 === m.show && null === m.threshold ? b > this.c.threshold : b > m.threshold) || !0 !== m.show && 1 >= q)) { this.dom.container.addClass(this.classes.hidden); this.s.displayed = !1; return } this.c.viewTotal &&
                0 === k.arrayTotals.length ? (this.s.rowData.totalOptions = 0, this._detailsPane()) : k.binsTotal = k.bins; this.dom.container.addClass(this.classes.show); this.s.displayed = !0
            } else if (null !== f && null !== f.searchPanes && null !== f.searchPanes.options) {
              if (void 0 !== f.tableLength) this.s.tableLength = f.tableLength, this.s.rowData.totalOptions = this.s.tableLength; else if (null === this.s.tableLength || g.rows()[0].length > this.s.tableLength) this.s.tableLength = g.rows()[0].length, this.s.rowData.totalOptions = this.s.tableLength; b = g.column(this.s.index).dataSrc();
              if (void 0 !== f.searchPanes.options[b]) for (q = 0, b = f.searchPanes.options[b]; q < b.length; q++)u = b[q], this.s.rowData.arrayFilter.push({ display: u.label, filter: u.value, sort: u.label, type: u.label }), this.s.rowData.bins[u.value] = this.c.viewTotal || this.c.cascadePanes ? u.count : u.total, this.s.rowData.binsTotal[u.value] = u.total; q = Object.keys(k.binsTotal).length; b = this._uniqueRatio(q, this.s.tableLength); if (!1 === this.s.displayed && ((void 0 === m.show && null === m.threshold ? b > this.c.threshold : b > m.threshold) || !0 !== m.show && 1 >=
                q)) { this.dom.container.addClass(this.classes.hidden); this.s.displayed = !1; return } this.s.rowData.arrayOriginal = this.s.rowData.arrayFilter; this.s.rowData.binsOriginal = this.s.rowData.bins; this.s.displayed = !0
            }
          } else this.s.displayed = !0; this._displayPane(); if (!this.s.listSet) this.dom.dtP.on("stateLoadParams.dt", function (x, C, y) { l.isEmptyObject(g.state.loaded()) && l.each(y, function (z, I) { delete y[z] }) }); null !== e && 0 < l(this.dom.panesContainer).has(e).length ? l(this.dom.container).insertAfter(e) : l(this.dom.panesContainer).prepend(this.dom.container);
        q = l.fn.dataTable.ext.errMode; l.fn.dataTable.ext.errMode = "none"; e = A.Scroller; this.s.dtPane = l(this.dom.dtP).DataTable(l.extend(!0, {
          columnDefs: [{
            className: "dtsp-nameColumn", data: "display", render: function (x, C, y) {
              if ("sort" === C) return y.sort; if ("type" === C) return y.type; var z = (d.s.filteringActive || d.s.showFiltered) && d.c.viewTotal || d.c.viewTotal && d.s.forceViewTotal ? v.replace(/{total}/, y.total) : r.replace(/{total}/, y.total); for (z = z.replace(/{shown}/, y.shown); -1 !== z.indexOf("{total}");)z = z.replace(/{total}/,
                y.total); for (; -1 !== z.indexOf("{shown}");)z = z.replace(/{shown}/, y.shown); y = '<span class="' + d.classes.pill + '">' + z + "</span>"; d.c.viewCount && m.viewCount || (y = ""); return "filter" === C ? "string" === typeof x && null !== x.match(/<[^>]*>/) ? x.replace(/<[^>]*>/g, "") : x : '<div class="' + d.classes.nameCont + '"><span title="' + ("string" === typeof x && null !== x.match(/<[^>]*>/) ? x.replace(/<[^>]*>/g, "") : x) + '" class="' + d.classes.name + '">' + x + "</span>" + y + "</div>"
            }, targets: 0, type: void 0 !== g.settings()[0].aoColumns[this.s.index] ? g.settings()[0].aoColumns[this.s.index]._sManualType :
              null
          }, { className: "dtsp-countColumn " + this.classes.badgePill, data: "shown", orderData: [1, 2], targets: 1, visible: !1 }, { data: "total", targets: 2, visible: !1 }], deferRender: !0, dom: "t", info: !1, language: this.s.dt.settings()[0].oLanguage, paging: e ? !0 : !1, scrollX: !1, scrollY: "200px", scroller: e ? !0 : !1, select: !0, stateSave: g.settings()[0].oFeatures.bStateSave ? !0 : !1
        }, this.c.dtOpts, void 0 !== m ? m.dtOpts : {}, void 0 === this.s.colOpts.options && this.colExists ? void 0 : { createdRow: function (x, C, y) { l(x).addClass(C.className) } }, null !==
        ...
        this.dom.searchBox.attr("placeholder", e); l.fn.dataTable.select.init(this.s.dtPane); l.fn.dataTable.ext.errMode = q; if (this.colExists) {
          h = (h = h.search()) ? h.substr(1, h.length - 2).split("|") : []; var w = 0; k.arrayFilter.forEach(function (x) { "" === x.filter && w++ }); q = 0; for (e = k.arrayFilter.length; q < e; q++) {
            h = !1; u = 0; for (var D = this.s.serverSelect; u < D.length; u++)b = D[u], b.filter === k.arrayFilter[q].filter && (h = !0); if (this.s.dt.page.info().serverSide && (!this.c.cascadePanes || this.c.cascadePanes && 0 !== k.bins[k.arrayFilter[q].filter] ||
              this.c.cascadePanes && null !== c || h)) for (h = this.addRow(k.arrayFilter[q].display, k.arrayFilter[q].filter, c ? k.binsTotal[k.arrayFilter[q].filter] : k.bins[k.arrayFilter[q].filter], this.c.viewTotal || c ? String(k.binsTotal[k.arrayFilter[q].filter]) : k.bins[k.arrayFilter[q].filter], k.arrayFilter[q].sort, k.arrayFilter[q].type), u = 0, D = this.s.serverSelect; u < D.length; u++)b = D[u], b.filter === k.arrayFilter[q].filter && (this.s.serverSelecting = !0, h.select(), this.s.serverSelecting = !1); else this.s.dt.page.info().serverSide ||
                !k.arrayFilter[q] || void 0 === k.bins[k.arrayFilter[q].filter] && this.c.cascadePanes ? this.s.dt.page.info().serverSide || this.addRow("", w, w, "", "", "") : this.addRow(k.arrayFilter[q].display, k.arrayFilter[q].filter, k.bins[k.arrayFilter[q].filter], k.binsTotal[k.arrayFilter[q].filter], k.arrayFilter[q].sort, k.arrayFilter[q].type)
          }
        } A.select.init(this.s.dtPane); (void 0 !== m.options || null !== this.customPaneSettings && void 0 !== this.customPaneSettings.options) && this._getComparisonRows(); this.s.dtPane.draw(); this.adjustTopRow();
        ...
        var a = this.s.dt; this.s.rowData.arrayTotals = []; this.s.rowData.binsTotal = {}; var b = this.s.dt.settings()[0]; a = a.rows().indexes(); if (!this.s.dt.page.info().serverSide) for (var f =
          0; f < a.length; f++)this._populatePaneArray(a[f], this.s.rowData.arrayTotals, b, this.s.rowData.binsTotal)
        ...
        var a = this.s.colOpts; a = void 0 !== a.options ? a.options : null !== this.customPaneSettings && void 0 !== this.customPaneSettings.options ? this.customPaneSettings.options : void 0; if (void 0 !== a) {
          var b = this.s.dt.rows({ search: "applied" }).data().toArray(), f = this.s.dt.rows({ search: "applied" }), c = this.s.dt.rows().data().toArray(), e = this.s.dt.rows(), d = []; this.s.dtPane.clear(); for (var g = 0; g < a.length; g++) {
            var h =
              a[g], m = "" !== h.label ? h.label : this.emptyMessage(), k = h.className, r = m, v = "function" === typeof h.value ? h.value : [], t = 0, u = m, q = 0; if ("function" === typeof h.value) { for (var w = 0; w < b.length; w++)h.value.call(this.s.dt, b[w], f[0][w]) && t++; for (w = 0; w < c.length; w++)h.value.call(this.s.dt, c[w], e[0][w]) && q++; "function" !== typeof v && v.push(h.filter) } (!this.c.cascadePanes || this.c.cascadePanes && 0 !== t) && d.push(this.addRow(r, v, t, q, u, m, k))
          } return d
        }
      }; n.prototype._getOptions = function () {
        var a = this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes,
        b = l.extend(!0, {}, n.defaults, { emptyMessage: !1, orthogonal: { threshold: null }, threshold: null }, a); void 0 !== a && void 0 !== a.hideCount && void 0 === a.viewCount && (b.viewCount = !a.hideCount); return b
      }; n.prototype._makeSelection = function () { this.updateTable(); this.s.updating = !0; this.s.dt.draw(); this.s.updating = !1 }; n.prototype._populatePane = function (a) {
        void 0 === a && (a = !1); var b = this.s.dt; this.s.rowData.arrayFilter = []; this.s.rowData.bins = {}; var f = this.s.dt.settings()[0]; if (!this.s.dt.page.info().serverSide) {
          var c = 0; for (a =
            (!this.c.cascadePanes && !this.c.viewTotal || this.s.clearing || a ? b.rows().indexes() : b.rows({ search: "applied" }).indexes()).toArray(); c < a.length; c++)this._populatePaneArray(a[c], this.s.rowData.arrayFilter, f)
        }
      }; n.prototype._populatePaneArray = function (a, b, f, c) {
        void 0 === c && (c = this.s.rowData.bins); var e = this.s.colOpts; if ("string" === typeof e.orthogonal) f = f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal), this.s.rowData.filterMap.set(a, f), this._addOption(f, f, f, f, b, c); else {
          var d = f.oApi._fnGetCellData(f, a, this.s.index,
            e.orthogonal.search); null === d && (d = ""); "string" === typeof d && (d = d.replace(/<[^>]*>/g, "")); this.s.rowData.filterMap.set(a, d); c[d] ? c[d]++ : (c[d] = 1, this._addOption(d, f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.display), f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.sort), f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.type), b, c)); this.s.rowData.totalOptions++
        }
      }; n.prototype._reloadSelect = function (a) {
        if (void 0 !== a) {
          for (var b, f = 0; f < a.searchPanes.panes.length; f++)if (a.searchPanes.panes[f].id ===
            this.s.index) { b = f; break } if (void 0 !== b) { f = this.s.dtPane; var c = f.rows({ order: "index" }).data().map(function (g) { return null !== g.filter ? g.filter.toString() : null }).toArray(), e = 0; for (a = a.searchPanes.panes[b].selected; e < a.length; e++) { b = a[e]; var d = -1; null !== b && (d = c.indexOf(b.toString())); -1 < d && (this.s.serverSelecting = !0, f.row(d).select(), this.s.serverSelecting = !1) } }
        }
      }; n.prototype._search = function (a, b) {
        for (var f = this.s.colOpts, c = this.s.dt, e = 0, d = this.selections; e < d.length; e++) {
          var g = d[e]; "string" === typeof g.filter &&
        ...
        function () { this.c.controls && this.s.colOpts.controls && l(this.dom.searchButton).appendTo(this.dom.searchLabelCont); !1 === this.c.dtOpts.searching || !1 === this.s.colOpts.dtOpts.searching || null !== this.customPaneSettings && void 0 !== this.customPaneSettings.dtOpts && void 0 !== this.customPaneSettings.dtOpts.searching && !this.customPaneSettings.dtOpts.searching || l(this.dom.searchLabelCont).appendTo(this.dom.searchCont) }; n.prototype._searchExtras = function () {
          var a = this.s.updating; this.s.updating = !0; var b = this.s.dtPane.rows({ selected: !0 }).data().pluck("filter").toArray(),
            f = b.indexOf(this.emptyMessage()), c = l(this.s.dtPane.table().container()); -1 < f && (b[f] = ""); 0 < b.length ? c.addClass(this.classes.selected) : 0 === b.length && c.removeClass(this.classes.selected); this.s.updating = a
        }; n.prototype._uniqueRatio = function (a, b) { return 0 < b && (0 < this.s.rowData.totalOptions && !this.s.dt.page.info().serverSide || this.s.dt.page.info().serverSide && 0 < this.s.tableLength) ? a / this.s.rowData.totalOptions : 1 }; n.prototype._updateCommon = function (a) {
          void 0 === a && (a = !1); if (!(this.s.dt.page.info().serverSide ||
            void 0 === this.s.dtPane || this.s.filteringActive && !this.c.cascadePanes && !0 !== a || !0 === this.c.cascadePanes && !0 === this.s.selectPresent || this.s.lastSelect && this.s.lastCascade)) {
              var b = this.s.colOpts, f = this.s.dtPane.rows({ selected: !0 }).data().toArray(); a = l(this.s.dtPane.table().node()).parent()[0].scrollTop; var c = this.s.rowData; this.s.dtPane.clear(); if (this.colExists) {
                0 === c.arrayFilter.length ? this._populatePane(!this.s.filteringActive) : this.c.cascadePanes && this.s.dt.rows().data().toArray().length === this.s.dt.rows({ search: "applied" }).data().toArray().length ?
                  (c.arrayFilter = c.arrayOriginal, c.bins = c.binsOriginal) : (this.c.viewTotal || this.c.cascadePanes) && this._populatePane(!this.s.filteringActive); this.c.viewTotal ? this._detailsPane() : c.binsTotal = c.bins; this.c.viewTotal && !this.c.cascadePanes && (c.arrayFilter = c.arrayTotals); for (var e = function (m) {
                    if (m && (void 0 !== c.bins[m.filter] && 0 !== c.bins[m.filter] && d.c.cascadePanes || !d.c.cascadePanes || d.s.clearing)) {
                      var k = d.addRow(m.display, m.filter, d.c.viewTotal ? void 0 !== c.bins[m.filter] ? c.bins[m.filter] : 0 : c.bins[m.filter],
                        d.c.viewTotal ? String(c.binsTotal[m.filter]) : c.bins[m.filter], m.sort, m.type), r = f.findIndex(function (v) { return v.filter === m.filter }); -1 !== r && (k.select(), f.splice(r, 1))
                    }
                  }, d = this, g = 0, h = c.arrayFilter; g < h.length; g++)e(h[g])
              } if (void 0 !== b.searchPanes && void 0 !== b.searchPanes.options || void 0 !== b.options || null !== this.customPaneSettings && void 0 !== this.customPaneSettings.options) for (e = function (m) { var k = f.findIndex(function (r) { if (r.display === m.data().display) return !0 }); -1 !== k && (m.select(), f.splice(k, 1)) }, g = 0,
                h = this._getComparisonRows(); g < h.length; g++)b = h[g], e(b); for (e = 0; e < f.length; e++)b = f[e], b = this.addRow(b.display, b.filter, 0, this.c.viewTotal ? b.total : 0, b.display, b.display), this.s.updating = !0, b.select(), this.s.updating = !1; this.s.dtPane.draw(); this.s.dtPane.table().node().parentNode.scrollTop = a
          }
        }; n.version = "1.3.0"; n.classes = {
          buttonGroup: "dtsp-buttonGroup", buttonSub: "dtsp-buttonSub", clear: "dtsp-clear", clearAll: "dtsp-clearAll", clearButton: "clearButton", container: "dtsp-searchPane", countButton: "dtsp-countButton",
          ...
          title: "dtsp-title", topRow: "dtsp-topRow"
        }; n.defaults = {
          cascadePanes: !1, clear: !0, combiner: "or", container: function (a) { return a.table().container() }, controls: !0, dtOpts: {}, emptyMessage: null, hideCount: !1, i18n: { clearPane: "&times;", count: "{total}", countFiltered: "{shown} ({total})", emptyMessage: "<em>No data</em>" }, layout: "auto", name: void 0, orderable: !0, orthogonal: { display: "display", filter: "filter", hideCount: !1, search: "filter", show: void 0, sort: "sort", threshold: .6, type: "type", viewCount: !0 }, preSelect: [], threshold: .6,
          viewCount: !0, viewTotal: !1
        }; return n
  }(), p, B, F = function () {
    function n(a, b, f) {
      var c = this; void 0 === f && (f = !1); this.regenerating = !1; if (!B || !B.versionCheck || !B.versionCheck("1.10.0")) throw Error("SearchPane requires DataTables 1.10 or newer"); if (!B.select) throw Error("SearchPane requires Select"); var e = new B.Api(a); this.classes = p.extend(!0, {}, n.classes); this.c = p.extend(!0, {}, n.defaults, b); this.dom = {
        clearAll: p('<button type="button">Clear All</button>').addClass(this.classes.clearAll), container: p("<div/>").addClass(this.classes.panes).text(e.i18n("searchPanes.loadMessage",
          this.c.i18n.loadMessage)), emptyMessage: p("<div/>").addClass(this.classes.emptyMessage), options: p("<div/>").addClass(this.classes.container), panes: p("<div/>").addClass(this.classes.container), title: p("<div/>").addClass(this.classes.title), titleRow: p("<div/>").addClass(this.classes.titleRow), wrapper: p("<div/>")
        ...
        this._getState(); if (this.s.dt.page.info().serverSide) e.on("preXhr.dt",
          function (d, g, h) { void 0 === h.searchPanes && (h.searchPanes = {}); void 0 === h.searchPanes_null && (h.searchPanes_null = {}); d = 0; for (g = c.s.selectionList; d < g.length; d++) { var m = g[d], k = c.s.dt.column(m.index).dataSrc(); void 0 === h.searchPanes[k] && (h.searchPanes[k] = {}); void 0 === h.searchPanes_null[k] && (h.searchPanes_null[k] = {}); for (var r = 0; r < m.rows.length; r++)h.searchPanes[k][r] = m.rows[r].filter, null === h.searchPanes[k][r] && (h.searchPanes_null[k][r] = !0) } }); e.on("xhr", function (d, g, h, m) {
            h && h.searchPanes && h.searchPanes.options &&
            (c.s.serverData = h, c.s.serverData.tableLength = h.recordsTotal, c._serverTotals())
          }); e.settings()[0]._searchPanes = this; this.dom.clearAll.text(e.i18n("searchPanes.clearMessage", this.c.i18n.clearMessage)); if (this.s.dt.settings()[0]._bInitComplete || f) this._paneDeclare(e, a, b); else e.one("preInit.dt", function (d) { c._paneDeclare(e, a, b) }); return this
      }
    } n.prototype.clearSelections = function () {
      this.dom.container.find("." + this.classes.search.replace(/\s+/g, ".")).each(function () { p(this).val(""); p(this).trigger("input") });
      for (var a = [], b = 0, f = this.s.panes; b < f.length; b++) { var c = f[b]; void 0 !== c.s.dtPane && a.push(c.clearPane()) } return a
    }; n.prototype.getNode = function () { return this.dom.container }; n.prototype.rebuild = function (a, b) {
      void 0 === a && (a = !1); void 0 === b && (b = !1); p(this.dom.emptyMessage).remove(); var f = []; !1 === a && p(this.dom.panes).empty(); for (var c = 0, e = this.s.panes; c < e.length; c++) {
        var d = e[c]; if (!1 === a || d.s.index === a) d.clearData(), f.push(d.rebuildPane(void 0 !== this.s.selectionList[this.s.selectionList.length - 1] ? d.s.index ===
          this.s.selectionList[this.s.selectionList.length - 1].index : !1, this.s.dt.page.info().serverSide ? this.s.serverData : void 0, null, b)), p(this.dom.panes).append(d.dom.container)
      } this.c.cascadePanes || this.c.viewTotal ? this.redrawPanes(!0) : this._updateSelection(); this._updateFilterCount(); this._attachPaneContainer(); this.s.dt.draw(); this.resizePanes(); return 1 === f.length ? f[0] : f
    }; n.prototype.redrawPanes = function (a) {
      void 0 === a && (a = !1); var b = this.s.dt; if (!this.s.updating && !this.s.dt.page.info().serverSide) {
        for (var f =
          !0, c = this.s.filterPane, e = null, d = 0, g = this.s.panes; d < g.length; d++) { var h = g[d]; void 0 !== h.s.dtPane && (e += h.s.dtPane.rows({ selected: !0 }).data().toArray().length) } if (0 === e && b.rows({ search: "applied" }).data().toArray().length === b.rows().data().toArray().length) f = !1; else if (this.c.viewTotal) {
            d = 0; for (g = this.s.panes; d < g.length; d++)if (h = g[d], void 0 !== h.s.dtPane) {
              var m = h.s.dtPane.rows({ selected: !0 }).data().toArray().length; if (0 === m) for (var k = 0, r = this.s.selectionList; k < r.length; k++) {
                var v = r[k]; v.index === h.s.index &&
                  0 !== v.rows.length && (m = v.rows.length)
              } 0 < m && -1 === c ? c = h.s.index : 0 < m && (c = null)
            } 0 === e && (c = null)
          } g = void 0; d = []; if (this.regenerating) { b = -1; 1 === d.length && null !== e && 0 !== e && (b = d[0].index); a = 0; for (d = this.s.panes; a < d.length; a++)if (h = d[a], void 0 !== h.s.dtPane) { g = !0; h.s.filteringActive = !0; if (-1 !== c && null !== c && c === h.s.index || !1 === f || h.s.index === b) g = !1, h.s.filteringActive = !1; h.updatePane(g ? f : g) } this._updateFilterCount() } else {
            m = 0; for (k = this.s.panes; m < k.length; m++)if (h = k[m], h.s.selectPresent) {
              this.s.selectionList.push({
                index: h.s.index,
                protect: !1, rows: h.s.dtPane.rows({ selected: !0 }).data().toArray()
              }); b.state.save(); break
            } else h.s.deselect && (g = h.s.index, r = h.s.dtPane.rows({ selected: !0 }).data().toArray(), 0 < r.length && this.s.selectionList.push({ index: h.s.index, protect: !0, rows: r })); if (0 < this.s.selectionList.length) for (b = this.s.selectionList[this.s.selectionList.length - 1].index, m = 0, k = this.s.panes; m < k.length; m++)h = k[m], h.s.lastSelect = h.s.index === b; for (h = 0; h < this.s.selectionList.length; h++)if (this.s.selectionList[h].index !== g || !0 === this.s.selectionList[h].protect) {
              b =
              !1; for (m = h + 1; m < this.s.selectionList.length; m++)this.s.selectionList[m].index === this.s.selectionList[h].index && (b = !0); b || (d.push(this.s.selectionList[h]), this.s.selectionList[h].protect = !1)
            } b = -1; 1 === d.length && null !== e && 0 !== e && (b = d[0].index); m = 0; for (k = this.s.panes; m < k.length; m++)if (h = k[m], void 0 !== h.s.dtPane) { g = !0; h.s.filteringActive = !0; if (-1 !== c && null !== c && c === h.s.index || !1 === f || h.s.index === b) g = !1, h.s.filteringActive = !1; h.updatePane(g ? f : !1) } this._updateFilterCount(); if (0 < d.length && (d.length < this.s.selectionList.length ||
              a)) for (this._cascadeRegen(d, e), b = d[d.length - 1].index, c = 0, a = this.s.panes; c < a.length; c++)h = a[c], h.s.lastSelect = h.s.index === b; else if (0 < d.length) for (h = 0, a = this.s.panes; h < a.length; h++)if (d = a[h], void 0 !== d.s.dtPane) { g = !0; d.s.filteringActive = !0; if (-1 !== c && null !== c && c === d.s.index || !1 === f || d.s.index === b) g = !1, d.s.filteringActive = !1; d.updatePane(g ? f : g) }
          } f && 0 !== e || (this.s.selectionList = [])
      }
    }; n.prototype.resizePanes = function () {
      if ("auto" === this.c.layout) {
        var a = p(this.s.dt.searchPanes.container()).width(), b = Math.floor(a /
          260); a = 1; for (var f = 0, c = [], e = 0, d = this.s.panes; e < d.length; e++) { var g = d[e]; g.s.displayed && c.push(g.s.index) } g = c.length; if (b === g) a = b; else for (; 1 < b; b--)if (e = g % b, 0 === e) { a = b; f = 0; break } else e > f && (a = b, f = e); c = 0 !== f ? c.slice(c.length - f, c.length) : []; b = 0; for (e = this.s.panes; b < e.length; b++)g = e[b], g.s.displayed && (d = "columns-" + (-1 === c.indexOf(g.s.index) ? a : f), g.resize(d))
      } else for (a = 0, f = this.s.panes; a < f.length; a++)g = f[a], g.adjustTopRow(); return this
    }; n.prototype._attach = function () {
      var a = this; p(this.dom.container).removeClass(this.classes.hide);
    ...
    }; n.prototype._attachExtras = function () { p(this.dom.container).removeClass(this.classes.hide); p(this.dom.titleRow).removeClass(this.classes.hide); p(this.dom.titleRow).remove(); p(this.dom.title).appendTo(this.dom.titleRow); this.c.clear && p(this.dom.clearAll).appendTo(this.dom.titleRow); p(this.dom.titleRow).appendTo(this.dom.container); return this.dom.container }; n.prototype._attachMessage = function () {
      try { var a = this.s.dt.i18n("searchPanes.emptyPanes", this.c.i18n.emptyPanes) } catch (b) {
        a =
        null
      } if (null === a) p(this.dom.container).addClass(this.classes.hide), p(this.dom.titleRow).removeClass(this.classes.hide); else return p(this.dom.container).removeClass(this.classes.hide), p(this.dom.titleRow).addClass(this.classes.hide), p(this.dom.emptyMessage).text(a), this.dom.emptyMessage.appendTo(this.dom.container), this.dom.container
    }; n.prototype._attachPaneContainer = function () { for (var a = 0, b = this.s.panes; a < b.length; a++)if (!0 === b[a].s.displayed) return this._attach(); return this._attachMessage() }; n.prototype._cascadeRegen =
      function (a, b) {
        this.regenerating = !0; var f = -1; 1 === a.length && null !== b && 0 !== b && (f = a[0].index); for (var c = 0, e = this.s.panes; c < e.length; c++)b = e[c], b.setCascadeRegen(!0), b.setClear(!0), (void 0 !== b.s.dtPane && b.s.index === f || void 0 !== b.s.dtPane) && b.clearPane(), b.setClear(!1); this.s.dt.draw(); f = this.s.dt.rows({ search: "applied" }).data().toArray().length; c = this.s.dt.rows().data().toArray().length; if (c !== f) { e = 0; for (var d = this.s.panes; e < d.length; e++)b = d[e], b.s.forceViewTotal = !0 } e = 0; for (d = this.s.panes; e < d.length; e++)b =
          d[e], b.updatePane(!0); this._makeCascadeSelections(a); this.s.selectionList = a; a = 0; for (e = this.s.panes; a < e.length; a++)b = e[a], b.setCascadeRegen(!1); this.regenerating = !1; if (c !== f) for (a = 0, f = this.s.panes; a < f.length; a++)b = f[a], b.s.forceViewTotal = !1
      }; n.prototype._checkMessage = function () { for (var a = 0, b = this.s.panes; a < b.length; a++)if (!0 === b[a].s.displayed) { p(this.dom.emptyMessage).remove(); p(this.dom.titleRow).removeClass(this.classes.hide); return } return this._attachMessage() }; n.prototype._getState = function () {
        var a =
          this.s.dt.state.loaded(); a && a.searchPanes && void 0 !== a.searchPanes.selectionList && (this.s.selectionList = a.searchPanes.selectionList)
      }; n.prototype._makeCascadeSelections = function (a) {
        for (var b = 0; b < a.length; b++)for (var f = function (g) {
          if (g.s.index === a[b].index && void 0 !== g.s.dtPane) {
            b === a.length - 1 && (g.s.lastCascade = !0); 0 < g.s.dtPane.rows({ selected: !0 }).data().toArray().length && void 0 !== g.s.dtPane && (g.setClear(!0), g.clearPane(), g.setClear(!1)); for (var h = function (r) {
              var v = !1; g.s.dtPane.rows().every(function (t) {
                void 0 !==
                g.s.dtPane.row(t).data() && void 0 !== r && g.s.dtPane.row(t).data().filter === r.filter && (v = !0, g.s.dtPane.row(t).select())
              }); v || g.addRow(r.display, r.filter, 0, r.total, r.sort, r.type, r.className).select()
            }, m = 0, k = a[b].rows; m < k.length; m++)h(k[m]); g.s.dtPane.draw(); c._updateFilterCount(); g.s.lastCascade = !1
          }
        }, c = this, e = 0, d = this.s.panes; e < d.length; e++)f(d[e]); this.s.dt.state.save()
      }; n.prototype._paneDeclare = function (a, b, f) {
        var c = this; a.columns(0 < this.c.columns.length ? this.c.columns : void 0).eq(0).each(function (h) {
          c.s.panes.push(new E(b,
            f, h, c.c.layout, c.dom.panes))
        }); for (var e = a.columns().eq(0).toArray().length, d = this.c.panes.length, g = 0; g < d; g++)this.s.panes.push(new E(b, f, e + g, this.c.layout, this.dom.panes, this.c.panes[g])); if (0 < this.c.order.length) for (e = this.c.order.map(function (h, m, k) { return c._findPane(h) }), this.dom.panes.empty(), this.s.panes = e, e = 0, d = this.s.panes; e < d.length; e++)this.dom.panes.append(d[e].dom.container); this.s.dt.settings()[0]._bInitComplete ? this._startup(a) : this.s.dt.settings()[0].aoInitComplete.push({ fn: function () { c._startup(a) } })
      };
    n.prototype._findPane = function (a) { for (var b = 0, f = this.s.panes; b < f.length; b++) { var c = f[b]; if (a === c.s.name) return c } }; n.prototype._serverTotals = function () {
      for (var a = !1, b = !1, f = this.s.dt, c = 0, e = this.s.panes; c < e.length; c++) {
        var d = e[c]; if (d.s.selectPresent) { this.s.selectionList.push({ index: d.s.index, protect: !1, rows: d.s.dtPane.rows({ selected: !0 }).data().toArray() }); f.state.save(); d.s.selectPresent = !1; a = !0; break } else d.s.deselect && (b = d.s.dtPane.rows({ selected: !0 }).data().toArray(), 0 < b.length && this.s.selectionList.push({
          index: d.s.index,
          protect: !0, rows: b
        }), b = a = !0)
      } if (a) { f = []; for (c = 0; c < this.s.selectionList.length; c++) { d = !1; for (e = c + 1; e < this.s.selectionList.length; e++)this.s.selectionList[e].index === this.s.selectionList[c].index && (d = !0); if (!d) { e = !1; a = 0; for (var g = this.s.panes; a < g.length; a++)d = g[a], d.s.index === this.s.selectionList[c].index && 0 < d.s.dtPane.rows({ selected: !0 }).data().toArray().length && (e = !0); e && f.push(this.s.selectionList[c]) } } this.s.selectionList = f } else this.s.selectionList = []; f = -1; if (b && 1 === this.s.selectionList.length) for (b =
    ...
    }; n.prototype._startup = function (a) {
      var b = this; p(this.dom.container).text(""); this._attachExtras(); p(this.dom.container).append(this.dom.panes);
      ...
      "auto" === this.c.layout && this.resizePanes(); this.s.stateRead || null === f || void 0 === f || (this.s.dt.page(f.start / this.s.dt.page.len()), this.s.dt.draw("page")); this.s.stateRead = !0; if (this.c.viewTotal && !this.c.cascadePanes) for (f = 0, c = this.s.panes; f < c.length; f++)g = c[f], g.updatePane(); this._updateFilterCount(); this._checkMessage(); a.on("preDraw.dtsps", function () {
        b.s.updating || (b._updateFilterCount(), !b.c.cascadePanes && !b.c.viewTotal || b.s.dt.page.info().serverSide ? b._updateSelection() : b.redrawPanes(b.c.viewTotal),
          b.s.filterPane = -1)
      }); p(window).on("resize.dtsp", B.util.throttle(function () { b.resizePanes() })); this.s.dt.on("stateSaveParams.dtsp", function (h, m, k) { void 0 === k.searchPanes && (k.searchPanes = {}); k.searchPanes.selectionList = b.s.selectionList }); if (this.s.dt.page.info().serverSide) a.off("page"), a.on("page", function () { b.s.page = b.s.dt.page() }), a.off("preXhr.dt"), a.on("preXhr.dt", function (h, m, k) {
        void 0 === k.searchPanes && (k.searchPanes = {}); void 0 === k.searchPanes_null && (k.searchPanes_null = {}); m = h = 0; for (var r = b.s.panes; m <
          r.length; m++) { var v = r[m], t = b.s.dt.column(v.s.index).dataSrc(); void 0 === k.searchPanes[t] && (k.searchPanes[t] = {}); void 0 === k.searchPanes_null[t] && (k.searchPanes_null[t] = {}); if (void 0 !== v.s.dtPane) { v = v.s.dtPane.rows({ selected: !0 }).data().toArray(); for (var u = 0; u < v.length; u++)k.searchPanes[t][u] = v[u].filter, null === k.searchPanes[t][u] && (k.searchPanes_null[t][u] = !0), h++ } } b.c.viewTotal && b._prepViewTotal(h); 0 < h && (h !== b.s.filterCount ? (k.start = 0, b.s.page = 0) : k.start = b.s.page * b.s.dt.page.len(), b.s.dt.page(b.s.page),
            b.s.filterCount = h)
      }); else a.on("preXhr.dt", function (h, m, k) { h = 0; for (m = b.s.panes; h < m.length; h++)m[h].clearData() }); this.s.dt.on("xhr", function (h, m, k, r) {
        if (m.nTable === b.s.dt.table().node()) {
          var v = !1; if (!b.s.dt.page.info().serverSide) b.s.dt.one("preDraw", function () {
            if (!v) {
              var t = b.s.dt.page(); v = !0; b.s.updating = !0; p(b.dom.panes).empty(); for (var u = 0, q = b.s.panes; u < q.length; u++) {
                var w = q[u]; w.clearData(); w.rebuildPane(void 0 !== b.s.selectionList[b.s.selectionList.length - 1] ? w.s.index === b.s.selectionList[b.s.selectionList.length -
                  1].index : !1, void 0, void 0, !0); p(b.dom.panes).append(w.dom.container)
              } b.s.dt.page.info().serverSide || b.s.dt.draw(); b.s.updating = !1; b.c.cascadePanes || b.c.viewTotal ? b.redrawPanes(b.c.cascadePanes) : b._updateSelection(); b._checkMessage(); b.s.dt.one("draw", function () { b.s.updating = !0; b.s.dt.page(t).draw(!1); b.s.updating = !1 })
            }
          })
        }
      }); f = 0; for (c = this.s.panes; f < c.length; f++)if (g = c[f], void 0 !== g && void 0 !== g.s.dtPane && (void 0 !== g.s.colOpts.preSelect && 0 < g.s.colOpts.preSelect.length || null !== g.customPaneSettings &&
      ...
      []; for (var a = 0, b = this.s.panes; a < b.length; a++) { var f = b[a]; void 0 !== f.s.dtPane && this.s.selectionList.push({ index: f.s.index, protect: !1, rows: f.s.dtPane.rows({ selected: !0 }).data().toArray() }) } this.s.dt.state.save()
    }; n.version = "1.3.0"; n.classes = { clear: "dtsp-clear", clearAll: "dtsp-clearAll", container: "dtsp-searchPanes", disabledButton: "dtsp-disabledButton", emptyMessage: "dtsp-emptyMessage", hide: "dtsp-hidden", panes: "dtsp-panesContainer", search: "dtsp-search", title: "dtsp-title", titleRow: "dtsp-titleRow" }; n.defaults =
    ...
    "function" === typeof define && define.amd ? define(["jquery",
      "datatables.net"], function (a) { return n(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, b) { a || (a = window); b && b.fn.dataTable || (b = require("datatables.net")(a, b).$); return n(b, a, a.document) } : n(window.jQuery, window, document)
  })(function (n, a, b) {
    function f(e, d, g) { void 0 === d && (d = null); void 0 === g && (g = !1); e = new c.Api(e); d = d ? d : e.init().searchPanes || c.defaults.searchPanes; return (new F(e, d, g)).getNode() } G(n); H(n); var c = n.fn.dataTable; n.fn.dataTable.SearchPanes = F; n.fn.DataTable.SearchPanes =
      F; n.fn.dataTable.SearchPane = E; n.fn.DataTable.SearchPane = E; a = n.fn.dataTable.Api.register; a("searchPanes()", function () { return this }); a("searchPanes.clearSelections()", function () { return this.iterator("table", function (e) { e._searchPanes && e._searchPanes.clearSelections() }) }); a("searchPanes.rebuildPane()", function (e, d) { return this.iterator("table", function (g) { g._searchPanes && g._searchPanes.rebuild(e, d) }) }); a("searchPanes.resizePanes()", function () {
        var e = this.context[0]; return e._searchPanes ? e._searchPanes.resizePanes() :
          null
      }); a("searchPanes.container()", function () { var e = this.context[0]; return e._searchPanes ? e._searchPanes.getNode() : null }); n.fn.dataTable.ext.buttons.searchPanesClear = { action: function (e, d, g, h) { d.searchPanes.clearSelections() }, text: "Clear Panes" }; n.fn.dataTable.ext.buttons.searchPanes = {
        action: function (e, d, g, h) { e.stopPropagation(); this.popover(h._panes.getNode(), { align: "dt-container" }); h._panes.rebuild(void 0, !0) }, config: {}, init: function (e, d, g) {
          var h = new n.fn.dataTable.SearchPanes(e, n.extend({
            filterChanged: function (k) {
              e.button(d).text(e.i18n("searchPanes.collapse",
                h.c.i18n.collapse, k))
            }
          }, g.config)), m = e.i18n("searchPanes.collapse", h.c.i18n.collapse, 0); e.button(d).text(m); g._panes = h
        }, text: "Search Panes"
      }; n(b).on("preInit.dt.dtsp", function (e, d, g) { "dt" === e.namespace && (d.oInit.searchPanes || c.defaults.searchPanes) && (d._searchPanes || f(d, null, !0)) }); c.ext.feature.push({ cFeature: "P", fnInit: f }); c.ext.features && c.ext.features.register("searchPanes", f)
  })
})();
...
*/
(function (c) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-searchpanes"], function (a) { return c(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, b) { a || (a = window); b && b.fn.dataTable || (b = require("datatables.net-bs5")(a, b).$); b.fn.dataTable.SearchPanes || require("datatables.net-searchpanes")(a, b); return c(b, a, a.document) } : c(jQuery, window, document) })(function (c, a, b) {
  a = c.fn.dataTable; c.extend(!0, a.SearchPane.classes, {
    buttonGroup: "btn-group",
    disabledButton: "disabled", narrow: "col", pane: { container: "table" }, paneButton: "btn btn-light", pill: "badge rounded-pill bg-secondary", search: "form-control search", table: "table table-sm table-borderless", topRow: "dtsp-topRow"
  }); c.extend(!0, a.SearchPanes.classes, { clearAll: "dtsp-clearAll btn btn-light", container: "dtsp-searchPanes", disabledButton: "disabled", panes: "dtsp-panes dtsp-panesContainer", title: "dtsp-title", titleRow: "dtsp-titleRow" }); return a.searchPanes
});
