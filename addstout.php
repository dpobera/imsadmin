...
$query = $db->query("SELECT stout_code FROM stout_tb ORDER BY stout_id DESC LIMIT 1");
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".newStinId").load("addrecord/orderid/auto-order-id-stout.php");
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary">STOCK INVENTORY OUT / Add New Record</h1>
            ...
            <div class="container-fluid mt-2 shadow-sm bg-light" style="background-color:#ededed;border:1px solid lightgrey;height:75vh">
                <form autocomplete="off" method="POST" action="addrecord/itemInsert/stoutInsert.php">
                    <div class="row mt-2 mb-2">
                        <div class="col-5">
                            <div class="row">
                                <div class="col">&nbsp;STOUT ID : <span class="newStinId"></span></div>
                            </div>
                            <div class="row mt-1">
                                <div class="col">
                                    <div class="col">
                                        <p class="text-secondary"> LAST RS No.: <strong><i><?php echo $code ?></i></strong> </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="floatingTextarea" name="stout_remarks"></textarea>
                                        <label for="floatingTextarea">Stock-Out Remarks</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-7" style="margin-top: 11vh;">
                            <div id="search">
                                <div class="form-floating mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <div class="form-floating mb-2">
                                            <button type="button" class="btn btn-secondary add-button mt-1" style="width: 100%;height:50px">GO <i class="bi bi-caret-down"></i></button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container--edit__button" style="margin-top: 2vh;margin-bottom: 2vh;z-index:50">
                        ...
                        <a href="stout-index.php"> <button type="button" class="btn btn-secondary">Cancel</button></a>
                    </div>
                </form>
            </div>
