...
if (isset($_POST['submit'])) {
    ...
    location.href = 'itemlist-index.php'</script>";
    ...
    <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
        ...
        <form method="POST">
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">ITEMLIST / Editing Records</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        <!-- <button type="button" class="btn btn-sm btn-outline-secondary">Export</button> -->
                        <div class="btnAdd">
                            <button type="submit" class="btn btn-secondary btn-sm bg-gradient" name="submit">Update Records</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid shadow-sm bg-light" style="background-color:#ededed;border:1px solid lightgrey;height:65vh;padding:5%">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control shadow-sm" id="floatingInput" placeholder="Item Name" name="product_name" value="<?php echo str_pad($id, 8, 0, STR_PAD_LEFT);; ?>" readonly>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control shadow-sm" id="floatingInput" placeholder="Item Name" name="product_name" value="<?php echo $product_name; ?>">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-floating mb-3">
                            <div class="form-floating">
                                <select class="form-select shadow-sm" id="floatingSelect" aria-label="Floating label select example" name="class_id">
                    ...
                    <div class="col-6">
                        <div class="form-floating">
                            <select class="form-select shadow-sm" id="floatingSelect" aria-label="Floating label select example" name="unit_id">
                ...
                <div class="row mt-2 mb-3">
                    <div class="col">
                        <div class="form-floating">
                            <select class="form-select shadow-sm" id="floatingSelect" aria-label="Floating label select example" name="dept_id">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <select class="form-select shadow-sm" id="floatingSelect" aria-label="Floating label select example" name="loc_id">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <select class="form-select shadow-sm" id="floatingSelect" aria-label="Floating label select example" name="product_type_id">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control shadow-sm" id="floatingInput" placeholder="Price" name="price" value="<?php echo $price; ?>">
                            <label for="floatingInput">Price</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control shadow-sm" id="floatingInput" placeholder="Cost" name="cost" value="<?php echo $cost; ?>">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-floating">
                            <textarea class="form-control shadow-sm" name="pro_remarks" id="floatingTextarea"><?php echo $pro_remarks; ?></textarea>
                    ...
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control shadow-sm" id="floatingInput" placeholder="Barcode" name="barcode" value="<?php echo $barcode; ?>">
