    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">CUSTOMER</h1>
            ...
            <div class="container-fluid bg-light" style="background-color:#ededed;border:1px solid lightgrey">
                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                    <table id="example" class="table table-hover  shadow mt-3 table-sm" style="background-color:white;border:1px solid lightgrey">
                        <thead class="table-light bg-gradient  sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                            <th style="color:grey" width="8%">&nbsp;CUS ID</th>
                            <th style="color:grey;" width="30%">CUSTOMER NAME</th>
                            <th style="color:grey" width="20%">ADDRESS</th>
                            <th style="color:grey" width="10%">CONTACT NO.</th>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "fnCreatedRow": function(nRow, aData, iDataIndex) {
                    $(nRow).attr('customers_id', aData[0]);
                },
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light" style="background-color: #ededed;">
                    <h5 class="modal-title text-secondary font-monospace" id="staticBackdropLabel">
                        <?php
                        include "addrecord/orderid/auto-order-id-item.php";
                        include "addrecord/orderid/auto-order-id-move.php"; ?>
                        CREATE NEW CUSTOMER
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body bg-light shadow-sm " style="background-color: #ededed;">
                    <form autocomplete="off" method="POST" class="form-inline p-3" action="addrecord/itemInsert/custInsert.php">
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control" id="floatingInput" name="customers_company" required>
                            <label class="text-uppercase" for="floatingInput">Customer Name</label>
                        </div>
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control" id="floatingInput" name="customers_name" required>
                            <label class="text-uppercase" for="floatingInput">Contact Person</label>
                        </div>
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control" id="floatingInput" name="customers_contact">
                            <label class="text-uppercase" for="floatingInput">Contact No.</label>
                        </div>
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control" id="floatingInput" name="customers_address" required>
                            <label class="text-uppercase" for="floatingInput">Address</label>
                        </div>

                        <div class="form-floating mb-3 shadow-sm">
                            <input type="number" class="form-control" id="floatingInput" name="customers_tin">
                            <label class="text-uppercase" for="floatingInput"> TIN No.</label>
                        </div>
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control" id="floatingInput" name="customers_note">
                            <label class="text-uppercase" for="floatingInput">NOTE</label>
                        </div>
                        <div class="form-floating  mb-3 shadow-sm">
                            ...
                            <label for="sel1" class="form-label text-uppercase">Tax Type</label>
                        </div>

                        <div class="row mt-4">
                            <div class="col"> <button type="submit" class="btn btn-secondary bg-gradient btn-md float-end" name="addcus">Save Record</button></div>
