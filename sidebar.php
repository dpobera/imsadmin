<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light bg-gradient sidebar collapse" style="overflow-y: visible; overflow-x:hidden">
    <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="report/stin_report.php?date1=&date2=&deptType=">
            ...
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="report/srr_select.php">
                    <span data-feather="home">SRR</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="report/sales-report.php?date1=&date2=">
