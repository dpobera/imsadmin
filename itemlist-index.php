    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">ITEMLIST RECORDS</h1>
            ...
            <div class="container-fluid bg-light" style="background-color:#ededed;border:1px solid lightgrey">
                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                    <table id="example" class="table table-hover table-sm shadow-sm" style="border:1px solid lightgrey;background-color:white;">
                        <thead class="table-light bg-gradient table-sm sticky-sm-top top-1 mb-2 mt-2 ml-2 bg-gradient" style="z-index:1;">
                            <th style="color:grey" width="8%">&nbsp;ITEM ID</th>
                            <th style="color:grey;" width="40%">ITEM DESCRIPTION</th>
                            <th style="color:grey" width="12%">CLASSIFICATION</th>
                            <th style="color:grey" width="2.5%">QTY</th>
                            <th style="color:grey" width="2.5%">UNIT</th>
                            <th style="color:grey" width="10%">REMARKS</th>
                            <th style="color:grey" width="5%">LOCATION</th>
                            <th style="color:grey;text-align:center" width="5%">SN</th>
                            <th style="color:grey" width="5%">DEPARTMENT</th>
                            <th style="color:grey;text-align:center" width="10%">ACTIONS</th>
                        </thead>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light font-monospace">
                ...
                <div class="modal-body bg-light">
                    <form method="GET" autocomplete="off" action="addrecord/itemInsert/itemInsert.php">
                        <div class="row">
                            <div class="col">
                                <input type="hidden" name="product_id" value="<?php echo $newOrderId ?>">
                                <input type="hidden" name="move_id" value="<?php echo $newOrderId2 ?>">
                ...
                <div class="modal-footer bg-light">
                    <button type="submit" class="btn btn-secondary bg-gradient btn-sm" name="add">Save Record</button>
                    <button class="btn btn-secondary bg-gradient btn-sm" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
                </div>
