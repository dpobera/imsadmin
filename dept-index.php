    ...
    <div class="container-fluid">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm bg-light" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary font-monospace">DEPARTMENT</h1>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card mt-4 shadow-sm">
                            <h6 class="card-header font-monospace" style="color:grey">CREATE NEW DEPARTMENT</h6>
                            <div class="card-body">
                                <div class="alert alert-secondary d-flex align-items-center" role="alert">
                                    ...
                                    <div>
                                        Please check on <strong>DEPARTMENT TABLE</strong> before creating new record !
                                    </div>
                                </div>
                                <form method="POST" action="addrecord/itemInsert/deptInsert.php">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="dept_name" required>
                                        <label for="floatingInput">Department</label>
                                    </div>
                                    <button class="btn btn-secondary bg-gradient btn-sm float-end" name="addDept">Save Record</button>
                                </form>
                                ...
                                <div class="table-responsive mt-2 mb-2" style="overflow-x:hidden;padding:1%;">
                                    <table id="example" class="table table-hover mt-3 table-sm" style="border:solid 1px lightgrey">
                                        <thead class="table-light bg-gradient  sticky-sm-top top-1 mb-2 mt-2 ml-2" style="z-index:1;">
                                            <th style="color:grey" width="8%">&nbsp;DEPARTMENT ID</th>
                                            <th style="color:grey;" width="30%">DEPARTMENT NAME</th>
                                        </thead>
                                    </table>
                                    <br>
                                </div>
