...
include 'php/ol_edit-inc_lazda.php';
?>
<style>
    thead {
        position: sticky;
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-md-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap align-items-center pt-3  mb-3 mt-2 p-3 border-bottom shadow-sm" style="background-color: #ededed;border:1px solid lightgrey">
                <h1 class="h2 text-secondary">LAZADA / Editing Records</h1>
            ...
            <form action="php/ol_edit-inc.php" method="POST">
                <div class="container-fluid shadow-sm p-4" style="background-color:#ededed;border:1px solid lightgrey">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-floating">
                                <select class="form-select" id="floatingSelect" name="oltypeId" disabled>
